...
typedef int32(*type_56)(xGoal*, void*, en_trantype*, float32, void*);
typedef void(*type_59)(zFrag*, float32);
typedef uint32(*type_65)(xAnimTransition*, xAnimSingle*, void*);
typedef void(*type_78)(void*);
typedef void(*type_83)(xAnimState*, xAnimSingle*, void*);
typedef void(*type_86)(xEnt*);
typedef void(*type_94)(xEnt*);
typedef RpClump*(*type_96)(RpClump*, void*);
typedef int32(*type_101)(xBase*, xBase*, uint32, float32*, xBase*);
typedef void(*type_104)(xAnimPlay*, xAnimState*);
typedef int32(*type_112)(void*, void*);
...
typedef xFactoryInst*(*type_138)(int32, RyzMemGrow*, void*);
typedef void(*type_141)(xEnt*);
typedef void(*type_144)(xFactoryInst*);
...
typedef zFrag* type_24[21];
typedef NPCBrainTableEntry type_27[63];
...
typedef float32 type_37[15];
typedef NPCMTypeTable type_39[250];
typedef analog_data type_40[2];
typedef RwFrame* type_41[2];
typedef uint32 type_42[15];
typedef RwFrustumPlane type_45[6];
...
typedef NPCSndQueue type_67[4];
typedef float32 type_68[6];
typedef float32 type_69[4];
typedef float32 type_70[2];
typedef xModelInstance* type_71[2];
typedef float32 type_72[3];
typedef float32 type_73[2];
typedef uint16 type_74[3];
typedef float32 type_75[3];
typedef xModelTag type_76[2];
typedef uint8 type_77[2];
typedef xVec4 type_79[12];
...
typedef xEnt* type_87[111];
typedef float32 type_88[12];
typedef float32 type_89[4];
typedef xGoal* type_90[5];
typedef float32 type_91[16];
typedef float32 type_92[12];
...
typedef uint8 type_114[5];
typedef xModelTag type_115[4];
typedef uint32 type_118[2];
typedef int8 type_119[32];
typedef xModelInstance* type_120[14];
typedef xVec3 type_121[3];
typedef uint32 type_122[4];
typedef uint8 type_123[4];
typedef uint32 type_124[2];
typedef int8 type_125[3];
typedef xParInterp type_126[1];
typedef float32 type_127[2];
typedef float32 type_129[2];
typedef uint16 type_131[3];
typedef uint8 type_132[4];
typedef float32 type_133[2];
typedef float32 type_136[16];
typedef uint8 type_139[22];
typedef int8 type_140[16];
typedef xParInterp type_142[4];
typedef uint8 type_143[22];
typedef xParInterp type_145[4];
typedef int8 type_146[128];
typedef int8 type_147[16];
typedef uint32 type_148[72];
typedef int8 type_149[4];
typedef xBase* type_150[72];
typedef int8 type_151[32];
typedef uint8 type_152[3];
typedef int8 type_153[32];
typedef RwTexCoords* type_154[8];
typedef xVec3 type_155[4];
typedef float32 type_156[4];
