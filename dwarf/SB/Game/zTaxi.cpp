...
typedef int32(*type_14)(xGoal*, void*, float32, void*);
...
typedef int32(*type_40)(xGoal*, void*, en_trantype*, float32, void*);
...
typedef void(*type_78)(int32*, en_trantype*);
typedef int32(*type_80)(xBase*, xBase*, uint32, float32*, xBase*);
typedef void(*type_94)(xEnt*, xScene*, float32);
typedef void(*type_99)(xEnt*, xVec3*);
typedef void(*type_101)(zFrag*, float32);
typedef void(*type_102)(xEnt*, xScene*, float32, xEntFrame*);
...
typedef uint16 type_117[3];
typedef uint8 type_118[14];
typedef xModelTag type_119[4];
typedef int8 type_120[32];
typedef int8 type_121[32];
...
int32 zTaxiEventCB(xBase* to, uint32 toEvent);
