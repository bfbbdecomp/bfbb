...
typedef struct zTaxi;
typedef struct xEntOrbitData;
typedef struct zLedgeGrabParams;
typedef enum answer_enum_0;
...
typedef void(*type_9)(zFrag*, zFragAsset*);
...
typedef s32(*type_14)(xGoal*, void*, f32, void*);
...
typedef void(*type_22)(zShrapnelAsset*, xModelInstance*, xVec3*, type_9);
...
typedef s32(*type_39)(RxNodeDefinition*);
typedef s32(*type_40)(xGoal*, void*, en_trantype*, f32, void*);
typedef s8*(*type_45)(xBase*);
typedef void(*type_46)(RxNodeDefinition*);
typedef u32(*type_50)(xAnimTransition*, xAnimSingle*, void*);
typedef s32(*type_51)(RxPipelineNode*);
typedef s8*(*type_53)(u32);
typedef void(*type_65)(xEnt*);
typedef void(*type_70)(xAnimState*, xAnimSingle*, void*);
typedef void(*type_72)(xEnt*);
typedef RpWorldSector*(*type_77)(RpWorldSector*);
typedef void(*type_78)(s32*, en_trantype*);
typedef s32(*type_80)(xBase*, xBase*, u32, f32*, xBase*);
typedef void(*type_94)(xEnt*, xScene*, f32);
typedef void(*type_99)(xEnt*, xVec3*);
typedef void(*type_101)(zFrag*, f32);
typedef void(*type_102)(xEnt*, xScene*, f32, xEntFrame*);
typedef void(*type_104)(xEnt*);
typedef RwCamera*(*type_105)(RwCamera*);
typedef void(*type_116)(xMemPool*, void*);
typedef void(*type_127)(RwResEntry*);
...
typedef s8 type_16[3];
typedef xVec3 type_20[5];
typedef u8 type_24[5];
...
typedef NPCSndQueue type_111[4];
typedef f32 type_112[2];
typedef s8 type_113[128];
typedef type_113 type_114[6];
typedef xModelInstance* type_115[2];
typedef u16 type_117[3];
typedef u8 type_118[14];
typedef xModelTag type_119[4];
typedef s8 type_120[32];
typedef s8 type_121[32];
typedef xModelInstance* type_122[14];
typedef xVec3 type_123[4];
typedef s8 type_124[32];
typedef u8 type_125[2];
typedef xAnimMultiFileEntry type_126[1];
typedef xVec3 type_128[16];
typedef xVec3 type_129[16];
typedef u8 type_130[4];
typedef f32 type_131[4];
typedef f32 type_132[4];
typedef xModelTag type_133[20];
typedef f32 type_134[4];
typedef xVec3 type_135[9];
typedef f32 type_136[16];
typedef s32 type_137[5];
typedef RxCluster type_138[1];
typedef u8 type_139[22];
...
struct zPlayerGlobals
{
	...
	type_55 Inv_PatsSock_Max;
	u32 Inv_PatsSock_CurrentLevel;
	type_60 Inv_LevelPickups;
...
// Start address: 0x39c160
void zTaxi_Load(zTaxi* taxi, xSerial* s)
{
}

// zTaxi_Save__FP5zTaxiP7xSerial
// Start address: 0x39c170
void zTaxi_Save(zTaxi* taxi, xSerial* s)
{
}

// zTaxi_Update__FP5xBaseP6xScenef
// Start address: 0x39c180
void zTaxi_Update(xBase* to, f32 dt)
{
	zTaxi* taxi;
	xCylinder c;
...
// zTaxi_Init__FR5xBaseR9xDynAssetUi
// Start address: 0x39c6d0
void zTaxi_Init(xBase& data, xDynAsset& asset)
{
}
