...
typedef s32(*type_44)(xBase*, xBase*, u32, f32*, xBase*);
typedef void(*type_46)(xEnt*, xScene*, f32, xEntCollis*);
typedef void(*type_50)(xAnimPlay*, xAnimState*);
typedef void(*type_53)(xAnimPlay*, xQuat*, xVec3*, s32);
typedef xBase*(*type_57)(u32);
typedef s8*(*type_59)(xBase*);
typedef s8*(*type_63)(u32);
...
typedef s8 type_51[128];
typedef type_51 type_52[6];
typedef u8 type_54[14];
...
zParEmitter* zParEmitterFind(s8* asset_name);
