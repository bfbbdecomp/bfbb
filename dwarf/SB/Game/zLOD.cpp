...
typedef void(*type_88)(xEnt*, xScene*, f32);
typedef xEnt*(*type_91)(xEnt*, xScene*, void*);
typedef void(*type_93)(RwResEntry*);
typedef void(*type_95)(xEnt*, xScene*, f32, xEntFrame*);

typedef u16 type_0[3];
typedef u8 type_2[14];
...
typedef u32 type_56[15];
typedef u32 type_57[15];
...
typedef f32 type_96[2];
typedef u8 type_97[3];
typedef u8 type_98[3];
typedef u8 type_99[3];
typedef f32 type_100[2];
typedef s8 type_101[128];
