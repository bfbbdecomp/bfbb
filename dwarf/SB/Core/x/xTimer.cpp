...
typedef s32(*type_27)(xBase*, xBase*, u32, f32*, xBase*);
typedef s32(*type_28)(RxPipelineNode*);
typedef void(*type_31)(xEnt*, xScene*, f32);
typedef u32(*type_32)(u32, xAnimActiveEffect*, xAnimSingle*, void*);
typedef void(*type_34)(xEnt*, xScene*, f32, xEntCollis*);
...
typedef u32 type_44[20];
typedef f32 type_45[6];
...
typedef u32 type_74[72];
typedef u16 type_75[3];
typedef s8 type_77[4];
...
void xTimerUpdate(xBase* to, f32 dt);
s32 xTimerEventCB(xBase* to, u32 toEvent, f32* toParam);
