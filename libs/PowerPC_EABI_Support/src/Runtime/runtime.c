...
static asm void __save_fpr(void)
{
    ...
    ENTRY_SAVE_FPR(16);
    ENTRY_SAVE_FPR2(16) stfd fp16, -128(save_restore_reg);
    ENTRY_SAVE_FPR(17);
    ENTRY_SAVE_FPR2(17) stfd fp17, -120(save_restore_reg);
    ENTRY_SAVE_FPR(18);
    ENTRY_SAVE_FPR2(18) stfd fp18, -112(save_restore_reg);
    ENTRY_SAVE_FPR(19);
    ENTRY_SAVE_FPR2(19) stfd fp19, -104(save_restore_reg);
    ENTRY_SAVE_FPR(20);
    ENTRY_SAVE_FPR2(20) stfd fp20, -96(save_restore_reg);
    ENTRY_SAVE_FPR(21);
    ENTRY_SAVE_FPR2(21) stfd fp21, -88(save_restore_reg);
    ENTRY_SAVE_FPR(22);
    ENTRY_SAVE_FPR2(22) stfd fp22, -80(save_restore_reg);
    ENTRY_SAVE_FPR(23);
    ENTRY_SAVE_FPR2(23) stfd fp23, -72(save_restore_reg);
    ENTRY_SAVE_FPR(24);
    ENTRY_SAVE_FPR2(24) stfd fp24, -64(save_restore_reg);
    ENTRY_SAVE_FPR(25);
    ENTRY_SAVE_FPR2(25) stfd fp25, -56(save_restore_reg);
    ENTRY_SAVE_FPR(26);
    ENTRY_SAVE_FPR2(26) stfd fp26, -48(save_restore_reg);
    ENTRY_SAVE_FPR(27);
    ENTRY_SAVE_FPR2(27) stfd fp27, -40(save_restore_reg);
    ENTRY_SAVE_FPR(28);
    ENTRY_SAVE_FPR2(28) stfd fp28, -32(save_restore_reg);
    ENTRY_SAVE_FPR(29);
    ENTRY_SAVE_FPR2(29) stfd fp29, -24(save_restore_reg);
    ENTRY_SAVE_FPR(30);
    ENTRY_SAVE_FPR2(30) stfd fp30, -16(save_restore_reg);
    ENTRY_SAVE_FPR(31);
    ENTRY_SAVE_FPR2(31) stfd fp31, -8(save_restore_reg);
    blr
}
...
static asm void __restore_fpr(void)
{
    ...
    ENTRY_RESTORE_FPR2(14) lfd fp14, -144(save_restore_reg);
    ENTRY_RESTORE_FPR(15);
    ENTRY_RESTORE_FPR2(15) lfd fp15, -136(save_restore_reg);
    ENTRY_RESTORE_FPR(16);
    ENTRY_RESTORE_FPR2(16) lfd fp16, -128(save_restore_reg);
    ENTRY_RESTORE_FPR(17);
    ENTRY_RESTORE_FPR2(17) lfd fp17, -120(save_restore_reg);
    ENTRY_RESTORE_FPR(18);
    ENTRY_RESTORE_FPR2(18) lfd fp18, -112(save_restore_reg);
    ENTRY_RESTORE_FPR(19);
    ENTRY_RESTORE_FPR2(19) lfd fp19, -104(save_restore_reg);
    ENTRY_RESTORE_FPR(20);
    ENTRY_RESTORE_FPR2(20) lfd fp20, -96(save_restore_reg);
    ENTRY_RESTORE_FPR(21);
    ENTRY_RESTORE_FPR2(21) lfd fp21, -88(save_restore_reg);
    ENTRY_RESTORE_FPR(22);
    ENTRY_RESTORE_FPR2(22) lfd fp22, -80(save_restore_reg);
    ENTRY_RESTORE_FPR(23);
    ENTRY_RESTORE_FPR2(23) lfd fp23, -72(save_restore_reg);
    ENTRY_RESTORE_FPR(24);
    ENTRY_RESTORE_FPR2(24) lfd fp24, -64(save_restore_reg);
    ENTRY_RESTORE_FPR(25);
    ENTRY_RESTORE_FPR2(25) lfd fp25, -56(save_restore_reg);
    ENTRY_RESTORE_FPR(26);
    ENTRY_RESTORE_FPR2(26) lfd fp26, -48(save_restore_reg);
    ENTRY_RESTORE_FPR(27);
    ENTRY_RESTORE_FPR2(27) lfd fp27, -40(save_restore_reg);
    ENTRY_RESTORE_FPR(28);
    ENTRY_RESTORE_FPR2(28) lfd fp28, -32(save_restore_reg);
    ENTRY_RESTORE_FPR(29);
    ENTRY_RESTORE_FPR2(29) lfd fp29, -24(save_restore_reg);
    ENTRY_RESTORE_FPR(30);
    ENTRY_RESTORE_FPR2(30) lfd fp30, -16(save_restore_reg);
    ENTRY_RESTORE_FPR(31);
    ENTRY_RESTORE_FPR2(31) lfd fp31, -8(save_restore_reg);
    blr
}
