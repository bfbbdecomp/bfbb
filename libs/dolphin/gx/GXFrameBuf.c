...
static void __GXVerifCopy(void* dest, u8 clear)
{
    ...
    ASSERTMSGLINE(1774, clmpB || y0 + dy <= 528,
                  "GXCopy: Have to set GX_CLAMP_BOTTOM if source bottom > 528");
    ASSERTMSGLINE(1779, (__GXData->peCtrl & 7) != 3 || clear == 0,
