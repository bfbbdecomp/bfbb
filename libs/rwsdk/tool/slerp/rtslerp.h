    ...
    {                                                                                              \
        ...
        {                                                                                          \
            ...
            /* ... so t must be in the interior then */                                            \
                                                                                                   \
            logBlend.imag.x =                                                                      \
                (sArgandCache)->logBase.imag.x + (rT) * (sArgandCache)->logTo.imag.x;              \
            logBlend.imag.y =                                                                      \
                (sArgandCache)->logBase.imag.y + (rT) * (sArgandCache)->logTo.imag.y;              \
            logBlend.imag.z =                                                                      \
                (sArgandCache)->logBase.imag.z + (rT) * (sArgandCache)->logTo.imag.z;              \
            logBlend.real = 0;                                                                     \
                                                                                                   \
...
extern void RtQuatSetupSlerpArgandCache(RtQuat* qpFrom, RtQuat* qpTo,
                                        RtQuatSlerpArgandCache* sArgandCache);

#if (defined(RWDEBUG) || defined(RWSUPPRESSINLINE))

extern void RtQuatSlerp(RtQuat* qpResult, RtQuat* qpFrom, RtQuat* qpTo, RwReal rT,
                        RtQuatSlerpCache* sCache);

extern void RtQuatSlerpArgand(RtQuat* qpResult, RtQuat* qpFrom, RtQuat* qpTo, RwReal rT,
                              RtQuatSlerpArgandCache* sArgandCache);
