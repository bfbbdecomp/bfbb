...
blacklistedInsns = {
    ...
    PPC_INS_XSMADDMDP, PPC_INS_XSMADDADP, PPC_INS_XSCMPUDP, PPC_INS_XSCMPODP,
    PPC_INS_XVCMPGTSP, PPC_INS_XXMRGHD, PPC_INS_XSMSUBMDP, PPC_INS_XSTDIVDP,
    PPC_INS_XVADDSP, PPC_INS_XVCMPEQSP, PPC_INS_XVMSUBASP, PPC_INS_XVCMPGESP, PPC_INS_XSMSUBADP,
    PPC_INS_XSMULDP, PPC_INS_XSNABSDP, PPC_INS_XSNEGDP, PPC_INS_XSNMADDADP,
    PPC_INS_XSNMADDMDP, PPC_INS_XSNMSUBADP, PPC_INS_XSNMSUBMDP, PPC_INS_XSSUBDP,
    PPC_INS_XSCPSGNDP, PPC_INS_XVMSUBMSP, PPC_INS_XXMRGHW, PPC_INS_XSADDDP, PPC_INS_XSDIVDP,
    PPC_INS_XXSPLTW, PPC_INS_XVNMSUBADP, PPC_INS_XVMADDMDP, PPC_INS_XVCMPGTDP, PPC_INS_VMRGHB,
	PPC_INS_VPKUHUM, PPC_INS_XVCMPEQDP, PPC_INS_XVMADDADP, PPC_INS_XVCMPGEDP, PPC_INS_XVMSUBADP,
