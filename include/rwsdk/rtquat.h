...
#define RtQuatModulusSquaredMacro(q)                                                               \
    ((q)->real * (q)->real + RwV3dDotProductMacro(&(q)->imag, &(q)->imag))
...
#define RtQuatExpMacro(result, q)                                                                  \
     ...
     */                  \
        ...
        factor = ((mod_b > (RwReal)0) ? (exp_a * ((RwReal)RwSin(mod_b)) / mod_b) : 0);             \
                                                                                                   \
        RwV3dScaleMacro(&(result)->imag, &(q)->imag, factor);                                      \
...
#define RtQuatConvertToMatrixMacro(qpQuat, mpMatrix)                                               \
    ...
    {                                                                                              \
        ...
        rwMatrixSetFlags((mpMatrix), (rwMATRIXTYPEORTHONORMAL & ~rwMATRIXINTERNALIDENTITY));       \
    }                                                                                              \
    MACRO_STOP
...
#define RtQuatInit(result, _x, _y, _z, _w) RtQuatInitMacro(result, _x, _y, _z, _w)

#define RtQuatAssign(to, from) RtQuatAssignMacro(to, from)

#define RtQuatAdd(result, q1, q2) RtQuatAddMacro(result, q1, q2)

#define RtQuatIncrementRealPart(result, s, q) RtQuatIncrementRealPartMacro(result, s, q)

#define RtQuatDecrementRealPart(result, s, q) RtQuatDecrementRealPartMacro(result, s, q)

#define RtQuatIncrement(result, dq) RtQuatIncrementMacro(result, dq)

#define RtQuatSub(result, q1, q2) RtQuatSubMacro(result, q1, q2)

#define RtQuatNegate(result, q) RtQuatNegateMacro(result, q)

#define RtQuatConjugate(result, q) RtQuatConjugateMacro(result, q)

#define RtQuatScale(result, q, scale) RtQuatScaleMacro(result, q, scale)

#define RtQuatModulusSquared(q) RtQuatModulusSquaredMacro(q)

#define RtQuatMultiply(result, q1, q2) RtQuatMultiplyMacro(result, q1, q2)

#define RtQuatReciprocal(result, q) RtQuatReciprocalMacro(result, q)

#define RtQuatSquare(result, q) RtQuatSquareMacro(result, q)

#define RtQuatSquareRoot(result, q) RtQuatSquareRootMacro(result, q)

#define RtQuatLog(result, q) RtQuatLogMacro(result, q)

#define RtQuatExp(result, q) RtQuatExpMacro(result, q)

#define RtQuatPow(result, q, e) RtQuatPowMacro(result, q, e)

#define RtQuatUnitLog(result, q) RtQuatUnitLogMacro(result, q)

#define RtQuatUnitExp(result, q) RtQuatUnitExpMacro(result, q)

#define RtQuatUnitPow(result, q, e) RtQuatUnitPowMacro(result, q, e)

#define RtQuatConvertToMatrix(qpQuat, mpMatrix) RtQuatConvertToMatrixMacro(qpQuat, mpMatrix)
...
extern RtQuat* RtQuatRotate(RtQuat* quat, const RwV3d* axis, RwReal angle,
                            RwOpCombineType combineOp);

extern const RtQuat* RtQuatQueryRotate(const RtQuat* quat, RwV3d* unitAxis, RwReal* angle);

extern RwV3d* RtQuatTransformVectors(RwV3d* vectorsOut, const RwV3d* vectorsIn,
...
extern void RtQuatInit(RtQuat* result, RwReal x, RwReal y, RwReal z, RwReal w);

extern void RtQuatAssign(RtQuat* to, RtQuat* from);

extern void RtQuatAdd(RtQuat* result, RtQuat* q1, RtQuat* q2);

extern void RtQuatIncrementRealPart(RtQuat* result, RwReal s, RtQuat* q);

extern void RtQuatDecrementRealPart(RtQuat* result, RwReal s, RtQuat* q);

extern void RtQuatIncrement(RtQuat* result, RtQuat* dq);

extern void RtQuatSub(RtQuat* result, RtQuat* q1, RtQuat* q2);

extern void RtQuatNegate(RtQuat* result, RtQuat* q);

extern void RtQuatConjugate(RtQuat* result, RtQuat* q);

extern void RtQuatScale(RtQuat* result, RtQuat* q, RwReal scale);

extern RwReal RtQuatModulusSquared(RtQuat* q);

extern void RtQuatMultiply(RtQuat* result, RtQuat* q1, RtQuat* q2);

extern void RtQuatReciprocal(RtQuat* result, RtQuat* q);

extern void RtQuatSquare(RtQuat* result, RtQuat* q);

extern void RtQuatSquareRoot(RtQuat* result, RtQuat* q);

extern void RtQuatLog(RtQuat* result, RtQuat* q);

extern void RtQuatExp(RtQuat* result, RtQuat* q);

extern void RtQuatPow(RtQuat* result, RtQuat* q, RwReal e);

extern void RtQuatUnitLog(RtQuat* result, RtQuat* q);

extern void RtQuatUnitExp(RtQuat* result, RtQuat* q);

extern void RtQuatUnitPow(RtQuat* result, RtQuat* q, RwReal e);

extern void RtQuatConvertToMatrix(const RtQuat* const qpQuat, RwMatrix* const mpMatrix);
...
#define RpAnimQuatConvertFromMatrix(qpQuat, mpMatrix) RtQuatConvertFromMatrix(qpQuat, mpMatrix)
