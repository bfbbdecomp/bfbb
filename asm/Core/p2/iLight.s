...
/* 800C4AF4 000C18F4  90 6D 92 08 */	stw r3, lbl_gLightWorld-_SDA_BASE_(r13)
...
/* 800C4BD0 000C19D0  C0 02 97 30 */	lfs f0, lbl__535_1-_SDA2_BASE_(r2)
/* 800C4BD4 000C19D4  D0 1D 00 08 */	stfs f0, 8(r29)
/* 800C4BD8 000C19D8  C0 02 97 30 */	lfs f0, lbl__535_1-_SDA2_BASE_(r2)
/* 800C4BDC 000C19DC  D0 1D 00 0C */	stfs f0, 0xc(r29)
/* 800C4BE0 000C19E0  C0 02 97 30 */	lfs f0, lbl__535_1-_SDA2_BASE_(r2)
/* 800C4BE4 000C19E4  D0 1D 00 10 */	stfs f0, 0x10(r29)
/* 800C4BE8 000C19E8  C0 02 97 30 */	lfs f0, lbl__535_1-_SDA2_BASE_(r2)
/* 800C4BEC 000C19EC  D0 1D 00 14 */	stfs f0, 0x14(r29)
/* 800C4BF0 000C19F0  C0 02 97 34 */	lfs f0, lbl__536-_SDA2_BASE_(r2)
/* 800C4BF4 000C19F4  D0 1D 00 1C */	stfs f0, 0x1c(r29)
/* 800C4BF8 000C19F8  C0 02 97 34 */	lfs f0, lbl__536-_SDA2_BASE_(r2)
/* 800C4BFC 000C19FC  D0 1D 00 20 */	stfs f0, 0x20(r29)
/* 800C4C00 000C1A00  C0 02 97 34 */	lfs f0, lbl__536-_SDA2_BASE_(r2)
/* 800C4C04 000C1A04  D0 1D 00 24 */	stfs f0, 0x24(r29)
/* 800C4C08 000C1A08  C0 02 97 34 */	lfs f0, lbl__536-_SDA2_BASE_(r2)
/* 800C4C0C 000C1A0C  D0 1D 00 28 */	stfs f0, 0x28(r29)
/* 800C4C10 000C1A10  C0 02 97 30 */	lfs f0, lbl__535_1-_SDA2_BASE_(r2)
/* 800C4C14 000C1A14  D0 1D 00 2C */	stfs f0, 0x2c(r29)
/* 800C4C18 000C1A18  C0 02 97 30 */	lfs f0, lbl__535_1-_SDA2_BASE_(r2)
/* 800C4C1C 000C1A1C  D0 1D 00 30 */	stfs f0, 0x30(r29)
/* 800C4C20 000C1A20  C0 02 97 34 */	lfs f0, lbl__536-_SDA2_BASE_(r2)
/* 800C4C24 000C1A24  D0 1D 00 34 */	stfs f0, 0x34(r29)
/* 800C4C28 000C1A28  C0 02 97 30 */	lfs f0, lbl__535_1-_SDA2_BASE_(r2)
...
/* 800C4C78 000C1A78  3C 60 80 25 */	lis r3, lbl_g_O3@ha
/* 800C4C7C 000C1A7C  38 83 30 18 */	addi r4, r3, lbl_g_O3@l
...
/* 800C4C8C 000C1A8C  3C 80 80 25 */	lis r4, lbl_g_O3@ha
/* 800C4C90 000C1A90  38 61 00 18 */	addi r3, r1, 0x18
/* 800C4C94 000C1A94  38 84 30 18 */	addi r4, r4, lbl_g_O3@l
