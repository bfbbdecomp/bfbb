...
/* 800CF460 000CC260  80 E2 97 EC */	lwz r7, lbl__542-_SDA2_BASE_(r2)
...
/* 800CF544 000CC344  90 6D 92 B8 */	stw r3, lbl_sMotionBlurEnabled-_SDA_BASE_(r13)
...
/* 800CF550 000CC350  C0 02 97 E8 */	lfs f0, lbl__527_1-_SDA2_BASE_(r2)
...
/* 800CF564 000CC364  90 0D 92 B8 */	stw r0, lbl_sMotionBlurEnabled-_SDA_BASE_(r13)
/* 800CF568 000CC368  48 00 00 3C */	b lbl_800CF5A4
lbl_800CF56C:
/* 800CF56C 000CC36C  C0 02 97 F4 */	lfs f0, lbl__575-_SDA2_BASE_(r2)
...
/* 800CF580 000CC380  3C 60 80 29 */	lis r3, lbl_sMBD@ha
/* 800CF584 000CC384  90 0D 92 B8 */	stw r0, lbl_sMotionBlurEnabled-_SDA_BASE_(r13)
/* 800CF588 000CC388  C0 42 97 FC */	lfs f2, lbl__577-_SDA2_BASE_(r2)
/* 800CF58C 000CC38C  C0 02 97 F8 */	lfs f0, lbl__576-_SDA2_BASE_(r2)
...
/* 800CF5A0 000CC3A0  90 03 2B 00 */	stw r0, lbl_sMBD@l(r3)
lbl_800CF5A4:
...
/* 800CF5B4 000CC3B4  3C 80 80 29 */	lis r4, lbl_sMBD@ha
/* 800CF5B8 000CC3B8  38 A0 00 90 */	li r5, 0x90
/* 800CF5BC 000CC3BC  90 01 00 14 */	stw r0, 0x14(r1)
/* 800CF5C0 000CC3C0  38 C4 2B 00 */	addi r6, r4, lbl_sMBD@l
...
/* 800CF618 000CC418  80 0D 92 B8 */	lwz r0, lbl_sMotionBlurEnabled-_SDA_BASE_(r13)
/* 800CF61C 000CC41C  28 00 00 00 */	cmplwi r0, 0
/* 800CF620 000CC420  41 82 00 1C */	beq lbl_800CF63C
/* 800CF624 000CC424  3C 80 80 29 */	lis r4, lbl_sMBD@ha
/* 800CF628 000CC428  80 04 2B 00 */	lwz r0, lbl_sMBD@l(r4)
...
.global iScrFX.iCameraOverlayRender__FP8RwCameraP8RwRaster6RwRGBA
iScrFX.iCameraOverlayRender__FP8RwCameraP8RwRaster6RwRGBA:
...
/* 800CF684 000CC484  3C 80 80 29 */	lis r4, lbl_sMBD@ha
/* 800CF688 000CC488  89 1F 00 00 */	lbz r8, 0(r31)
/* 800CF68C 000CC48C  38 E4 2B 00 */	addi r7, r4, lbl_sMBD@l
...
lbl_800CF758:
/* 800CF758 000CC558  3C 80 80 29 */	lis r4, lbl_sMBD@ha
/* 800CF75C 000CC55C  38 60 00 03 */	li r3, 3
/* 800CF760 000CC560  38 C4 2B 00 */	addi r6, r4, lbl_sMBD@l
...
/* 800CF814 000CC614  3C 60 80 29 */	lis r3, lbl_sMBD@ha
/* 800CF818 000CC618  3B E3 2B 00 */	addi r31, r3, lbl_sMBD@l
...
/* 800CF85C 000CC65C  3C A0 80 29 */	lis r5, lbl_sMBD@ha
/* 800CF860 000CC660  90 01 00 14 */	stw r0, 0x14(r1)
/* 800CF864 000CC664  38 A5 2B 00 */	addi r5, r5, lbl_sMBD@l
...
/* 800CF874 000CC674  80 02 98 00 */	lwz r0, lbl__714_2-_SDA2_BASE_(r2)
...
/* 800CF890 000CC690  4B FF FD DD */	bl iScrFX.iCameraOverlayRender__FP8RwCameraP8RwRaster6RwRGBA
lbl_800CF894:
...
/* 800CF8B4 000CC6B4  80 6D 92 BC */	lwz r3, lbl_g_rast_gctapdance-_SDA_BASE_(r13)
...
/* 800CF8C8 000CC6C8  90 0D 92 BC */	stw r0, lbl_g_rast_gctapdance-_SDA_BASE_(r13)
/* 800CF8CC 000CC6CC  90 0D 92 C0 */	stw r0, lbl_g_alreadyTriedAlloc-_SDA_BASE_(r13)
...
/* 800CF8EC 000CC6EC  80 0D 92 BC */	lwz r0, lbl_g_rast_gctapdance-_SDA_BASE_(r13)
/* 800CF8F0 000CC6F0  28 00 00 00 */	cmplwi r0, 0
/* 800CF8F4 000CC6F4  40 82 00 14 */	bne lbl_800CF908
/* 800CF8F8 000CC6F8  80 0D 92 C0 */	lwz r0, lbl_g_alreadyTriedAlloc-_SDA_BASE_(r13)
...
lbl_800CF908:
/* 800CF908 000CC708  80 6D 92 BC */	lwz r3, lbl_g_rast_gctapdance-_SDA_BASE_(r13)
