...
/* 800CF564 000CC364  90 0D 92 B8 */	stw r0, sMotionBlurEnabled-_SDA_BASE_(r13)
...
/* 800CF580 000CC380  3C 60 80 29 */	lis r3, sMBD@ha
/* 800CF584 000CC384  90 0D 92 B8 */	stw r0, sMotionBlurEnabled-_SDA_BASE_(r13)
...
/* 800CF5A0 000CC3A0  90 03 2B 00 */	stw r0, sMBD@l(r3)
lbl_800CF5A4:
...
/* 800CF5B4 000CC3B4  3C 80 80 29 */	lis r4, sMBD@ha
/* 800CF5B8 000CC3B8  38 A0 00 90 */	li r5, 0x90
/* 800CF5BC 000CC3BC  90 01 00 14 */	stw r0, 0x14(r1)
/* 800CF5C0 000CC3C0  38 C4 2B 00 */	addi r6, r4, sMBD@l
...
/* 800CF684 000CC484  3C 80 80 29 */	lis r4, sMBD@ha
/* 800CF688 000CC488  89 1F 00 00 */	lbz r8, 0(r31)
/* 800CF68C 000CC48C  38 E4 2B 00 */	addi r7, r4, sMBD@l
...
lbl_800CF758:
/* 800CF758 000CC558  3C 80 80 29 */	lis r4, sMBD@ha
/* 800CF75C 000CC55C  38 60 00 03 */	li r3, 3
/* 800CF760 000CC560  38 C4 2B 00 */	addi r6, r4, sMBD@l
...
/* 800CF814 000CC614  3C 60 80 29 */	lis r3, sMBD@ha
/* 800CF818 000CC618  3B E3 2B 00 */	addi r31, r3, sMBD@l
...
/* 800CF85C 000CC65C  3C A0 80 29 */	lis r5, sMBD@ha
/* 800CF860 000CC660  90 01 00 14 */	stw r0, 0x14(r1)
/* 800CF864 000CC664  38 A5 2B 00 */	addi r5, r5, sMBD@l
...
sMotionBlurEnabled:
	.skip 0x4
.global g_rast_gctapdance
g_rast_gctapdance:
	.skip 0x4
.global g_alreadyTriedAlloc
g_alreadyTriedAlloc:
	.skip 0x8
/* SPECULATION: link order */
