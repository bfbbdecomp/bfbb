...
/* 800BF200 000BC000  C0 02 96 70 */	lfs f0, lbl__661_1-_SDA2_BASE_(r2)
...
/* 800BF2F8 000BC0F8  C8 82 96 98 */	lfd f4, lbl__671_3-_SDA2_BASE_(r2)
/* 800BF2FC 000BC0FC  90 01 00 54 */	stw r0, 0x54(r1)
/* 800BF300 000BC100  C0 A2 96 74 */	lfs f5, lbl__662-_SDA2_BASE_(r2)
...
/* 800BF328 000BC128  C8 82 96 98 */	lfd f4, lbl__671_3-_SDA2_BASE_(r2)
/* 800BF32C 000BC12C  6C 00 80 00 */	xoris r0, r0, 0x8000
/* 800BF330 000BC130  C0 A2 96 74 */	lfs f5, lbl__662-_SDA2_BASE_(r2)
...
/* 800BF354 000BC154  C8 82 96 98 */	lfd f4, lbl__671_3-_SDA2_BASE_(r2)
/* 800BF358 000BC158  6C 00 80 00 */	xoris r0, r0, 0x8000
/* 800BF35C 000BC15C  C0 A2 96 74 */	lfs f5, lbl__662-_SDA2_BASE_(r2)
...
/* 800BF378 000BC178  C8 82 96 98 */	lfd f4, lbl__671_3-_SDA2_BASE_(r2)
/* 800BF37C 000BC17C  6C 00 80 00 */	xoris r0, r0, 0x8000
/* 800BF380 000BC180  C0 A2 96 74 */	lfs f5, lbl__662-_SDA2_BASE_(r2)
...
/* 800BF3A0 000BC1A0  C8 82 96 98 */	lfd f4, lbl__671_3-_SDA2_BASE_(r2)
...
/* 800BF3C0 000BC1C0  C8 82 96 98 */	lfd f4, lbl__671_3-_SDA2_BASE_(r2)
...
/* 800BF3E4 000BC1E4  C8 82 96 98 */	lfd f4, lbl__671_3-_SDA2_BASE_(r2)
...
/* 800BF438 000BC238  C8 22 96 98 */	lfd f1, lbl__671_3-_SDA2_BASE_(r2)
/* 800BF43C 000BC23C  7F 3C 02 14 */	add r25, r28, r0
/* 800BF440 000BC240  C0 42 96 74 */	lfs f2, lbl__662-_SDA2_BASE_(r2)
...
/* 800BF570 000BC370  C0 02 96 70 */	lfs f0, lbl__661_1-_SDA2_BASE_(r2)
...
lbl_800BF590:
/* 800BF590 000BC390  C0 02 96 78 */	lfs f0, lbl__663-_SDA2_BASE_(r2)
...
/* 800BF5C8 000BC3C8  C1 02 96 90 */	lfs f8, lbl__669_3-_SDA2_BASE_(r2)
/* 800BF5CC 000BC3CC  EC 00 00 72 */	fmuls f0, f0, f1
/* 800BF5D0 000BC3D0  C0 42 96 8C */	lfs f2, lbl__668_3-_SDA2_BASE_(r2)
/* 800BF5D4 000BC3D4  EC 3C 00 72 */	fmuls f1, f28, f1
/* 800BF5D8 000BC3D8  C0 62 96 88 */	lfs f3, lbl__667_1-_SDA2_BASE_(r2)
/* 800BF5DC 000BC3DC  C0 E2 96 84 */	lfs f7, lbl__666_1-_SDA2_BASE_(r2)
/* 800BF5E0 000BC3E0  ED 20 00 32 */	fmuls f9, f0, f0
/* 800BF5E4 000BC3E4  ED 41 00 72 */	fmuls f10, f1, f1
/* 800BF5E8 000BC3E8  C0 C2 96 80 */	lfs f6, lbl__665-_SDA2_BASE_(r2)
/* 800BF5EC 000BC3EC  C0 A2 96 7C */	lfs f5, lbl__664-_SDA2_BASE_(r2)
...
/* 800BF6BC 000BC4BC  C8 82 96 98 */	lfd f4, lbl__671_3-_SDA2_BASE_(r2)
...
/* 800BF800 000BC600  3C E0 80 26 */	lis r7, lbl__1073@ha
/* 800BF804 000BC604  39 47 01 18 */	addi r10, r7, lbl__1073@l
...
/* 800BF8BC 000BC6BC  C0 62 96 70 */	lfs f3, lbl__661_1-_SDA2_BASE_(r2)
...
/* 800BF8E4 000BC6E4  C8 82 96 98 */	lfd f4, lbl__671_3-_SDA2_BASE_(r2)
...
/* 800BF9C4 000BC7C4  C0 62 96 70 */	lfs f3, lbl__661_1-_SDA2_BASE_(r2)
...
lbl_800BFA08:
/* 800BFA08 000BC808  C0 62 96 78 */	lfs f3, lbl__663-_SDA2_BASE_(r2)
...
/* 800BFA68 000BC868  C0 62 96 70 */	lfs f3, lbl__661_1-_SDA2_BASE_(r2)
...
/* 800BFAB8 000BC8B8  C8 82 96 98 */	lfd f4, lbl__671_3-_SDA2_BASE_(r2)
...
/* 800BFB34 000BC934  C8 82 96 98 */	lfd f4, lbl__671_3-_SDA2_BASE_(r2)
...
/* 800BFBAC 000BC9AC  C0 22 96 70 */	lfs f1, lbl__661_1-_SDA2_BASE_(r2)
...
/* 800BFBD0 000BC9D0  C0 22 96 70 */	lfs f1, lbl__661_1-_SDA2_BASE_(r2)
...
/* 800BFBF4 000BC9F4  C0 22 96 70 */	lfs f1, lbl__661_1-_SDA2_BASE_(r2)
...
/* 800BFCA0 000BCAA0  C0 22 96 A0 */	lfs f1, lbl__1262_1-_SDA2_BASE_(r2)
...
/* 800BFCB4 000BCAB4  C8 82 96 98 */	lfd f4, lbl__671_3-_SDA2_BASE_(r2)
...
/* 800BFD70 000BCB70  C8 C2 96 A8 */	lfd f6, lbl__1267_3-_SDA2_BASE_(r2)
...
/* 800BFD80 000BCB80  C8 A2 96 98 */	lfd f5, lbl__671_3-_SDA2_BASE_(r2)
...
/* 800BFE08 000BCC08  C9 42 96 A8 */	lfd f10, lbl__1267_3-_SDA2_BASE_(r2)
/* 800BFE0C 000BCC0C  C9 02 96 98 */	lfd f8, lbl__671_3-_SDA2_BASE_(r2)
...
/* 800BFE4C 000BCC4C  C9 02 96 A8 */	lfd f8, lbl__1267_3-_SDA2_BASE_(r2)
/* 800BFE50 000BCC50  C8 C2 96 98 */	lfd f6, lbl__671_3-_SDA2_BASE_(r2)
...
/* 800BFE90 000BCC90  C8 C2 96 A8 */	lfd f6, lbl__1267_3-_SDA2_BASE_(r2)
/* 800BFE94 000BCC94  C8 82 96 98 */	lfd f4, lbl__671_3-_SDA2_BASE_(r2)
...
/* 800BFEF8 000BCCF8  C8 C2 96 A8 */	lfd f6, lbl__1267_3-_SDA2_BASE_(r2)
/* 800BFEFC 000BCCFC  C8 82 96 98 */	lfd f4, lbl__671_3-_SDA2_BASE_(r2)
...
/* 800BFF88 000BCD88  C9 42 96 A8 */	lfd f10, lbl__1267_3-_SDA2_BASE_(r2)
/* 800BFF8C 000BCD8C  C9 02 96 98 */	lfd f8, lbl__671_3-_SDA2_BASE_(r2)
...
/* 800BFFCC 000BCDCC  C9 02 96 A8 */	lfd f8, lbl__1267_3-_SDA2_BASE_(r2)
/* 800BFFD0 000BCDD0  C8 C2 96 98 */	lfd f6, lbl__671_3-_SDA2_BASE_(r2)
...
/* 800C0010 000BCE10  C8 C2 96 A8 */	lfd f6, lbl__1267_3-_SDA2_BASE_(r2)
/* 800C0014 000BCE14  C8 82 96 98 */	lfd f4, lbl__671_3-_SDA2_BASE_(r2)
...
/* 800C0090 000BCE90  C8 C2 96 A8 */	lfd f6, lbl__1267_3-_SDA2_BASE_(r2)
...
/* 800C00A0 000BCEA0  C8 A2 96 98 */	lfd f5, lbl__671_3-_SDA2_BASE_(r2)
