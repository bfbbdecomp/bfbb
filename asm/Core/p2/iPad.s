...
/* 800CA94C 000C774C  3C 80 80 3C */	lis r4, lbl_gTrcPad@ha
/* 800CA950 000C7750  38 A0 00 02 */	li r5, 2
/* 800CA954 000C7754  B0 03 00 56 */	sth r0, 0x56(r3)
/* 800CA958 000C7758  38 84 EF 88 */	addi r4, r4, lbl_gTrcPad@l
...
.global iPad.iPadConvStick__Ff
iPad.iPadConvStick__Ff:
/* 800CA98C 000C778C  94 21 FF F0 */	stwu r1, -0x10(r1)
/* 800CA990 000C7790  C0 02 97 98 */	lfs f0, lbl__677_2-_SDA2_BASE_(r2)
...
lbl_800CA9A4:
/* 800CA9A4 000C77A4  C0 02 97 9C */	lfs f0, lbl__678_1-_SDA2_BASE_(r2)
...
lbl_800CA9B4:
/* 800CA9B4 000C77B4  C0 42 97 A0 */	lfs f2, lbl__679_2-_SDA2_BASE_(r2)
/* 800CA9B8 000C77B8  C0 02 97 A4 */	lfs f0, lbl__680_3-_SDA2_BASE_(r2)
...
lbl_800CA9D0:
/* 800CA9D0 000C77D0  C0 02 97 A8 */	lfs f0, lbl__681_2-_SDA2_BASE_(r2)
...
/* 800CAA20 000C7820  3C 60 80 29 */	lis r3, lbl_sPadData@ha
/* 800CAA24 000C7824  38 63 26 20 */	addi r3, r3, lbl_sPadData@l
/* 800CAA28 000C7828  48 10 DE F9 */	bl PADRead
/* 800CAA2C 000C782C  3C 60 80 29 */	lis r3, lbl_sPadData@ha
/* 800CAA30 000C7830  38 63 26 20 */	addi r3, r3, lbl_sPadData@l
/* 800CAA34 000C7834  48 10 D1 5D */	bl PADClamp
lbl_800CAA38:
/* 800CAA38 000C7838  A8 7D 00 54 */	lha r3, 0x54(r29)
/* 800CAA3C 000C783C  3C 80 80 29 */	lis r4, lbl_sPadData@ha
/* 800CAA40 000C7840  38 A4 26 20 */	addi r5, r4, lbl_sPadData@l
...
/* 800CAAB0 000C78B0  48 00 03 89 */	bl iPad.iPadConvFromGCN__FUiUiUi
/* 800CAAB4 000C78B4  A8 1D 00 54 */	lha r0, 0x54(r29)
/* 800CAAB8 000C78B8  3C 80 80 29 */	lis r4, lbl_sPadData@ha
/* 800CAABC 000C78BC  38 C4 26 20 */	addi r6, r4, lbl_sPadData@l
...
/* 800CAAD4 000C78D4  48 00 03 65 */	bl iPad.iPadConvFromGCN__FUiUiUi
/* 800CAAD8 000C78D8  A8 1D 00 54 */	lha r0, 0x54(r29)
/* 800CAADC 000C78DC  3C 80 80 29 */	lis r4, lbl_sPadData@ha
/* 800CAAE0 000C78E0  38 C4 26 20 */	addi r6, r4, lbl_sPadData@l
...
/* 800CAAF8 000C78F8  48 00 03 41 */	bl iPad.iPadConvFromGCN__FUiUiUi
/* 800CAAFC 000C78FC  A8 1D 00 54 */	lha r0, 0x54(r29)
/* 800CAB00 000C7900  3C 80 80 29 */	lis r4, lbl_sPadData@ha
/* 800CAB04 000C7904  38 C4 26 20 */	addi r6, r4, lbl_sPadData@l
...
/* 800CAB1C 000C791C  48 00 03 1D */	bl iPad.iPadConvFromGCN__FUiUiUi
/* 800CAB20 000C7920  A8 1D 00 54 */	lha r0, 0x54(r29)
/* 800CAB24 000C7924  3C 80 80 29 */	lis r4, lbl_sPadData@ha
/* 800CAB28 000C7928  38 84 26 20 */	addi r4, r4, lbl_sPadData@l
...
/* 800CAB48 000C7948  48 00 02 F1 */	bl iPad.iPadConvFromGCN__FUiUiUi
/* 800CAB4C 000C794C  A8 1D 00 54 */	lha r0, 0x54(r29)
/* 800CAB50 000C7950  3C 80 80 29 */	lis r4, lbl_sPadData@ha
/* 800CAB54 000C7954  38 C4 26 20 */	addi r6, r4, lbl_sPadData@l
...
/* 800CAB6C 000C796C  48 00 02 CD */	bl iPad.iPadConvFromGCN__FUiUiUi
/* 800CAB70 000C7970  A8 1D 00 54 */	lha r0, 0x54(r29)
/* 800CAB74 000C7974  3C 80 80 29 */	lis r4, lbl_sPadData@ha
/* 800CAB78 000C7978  38 84 26 20 */	addi r4, r4, lbl_sPadData@l
...
lbl_800CAB98:
/* 800CAB98 000C7998  3C 60 80 29 */	lis r3, lbl_sPadData@ha
/* 800CAB9C 000C799C  38 03 26 20 */	addi r0, r3, lbl_sPadData@l
...
/* 800CABC4 000C79C4  48 00 02 75 */	bl iPad.iPadConvFromGCN__FUiUiUi
/* 800CABC8 000C79C8  A8 1D 00 54 */	lha r0, 0x54(r29)
/* 800CABCC 000C79CC  3C 80 80 29 */	lis r4, lbl_sPadData@ha
/* 800CABD0 000C79D0  38 C4 26 20 */	addi r6, r4, lbl_sPadData@l
...
/* 800CABE8 000C79E8  48 00 02 51 */	bl iPad.iPadConvFromGCN__FUiUiUi
/* 800CABEC 000C79EC  A8 1D 00 54 */	lha r0, 0x54(r29)
/* 800CABF0 000C79F0  3C 80 80 29 */	lis r4, lbl_sPadData@ha
/* 800CABF4 000C79F4  38 84 26 20 */	addi r4, r4, lbl_sPadData@l
...
lbl_800CAC14:
/* 800CAC14 000C7A14  3C 60 80 29 */	lis r3, lbl_sPadData@ha
/* 800CAC18 000C7A18  38 03 26 20 */	addi r0, r3, lbl_sPadData@l
...
/* 800CAC34 000C7A34  3C 60 80 29 */	lis r3, lbl_sPadData@ha
/* 800CAC38 000C7A38  38 63 26 20 */	addi r3, r3, lbl_sPadData@l
...
/* 800CAC4C 000C7A4C  48 00 01 ED */	bl iPad.iPadConvFromGCN__FUiUiUi
/* 800CAC50 000C7A50  A8 1D 00 54 */	lha r0, 0x54(r29)
/* 800CAC54 000C7A54  3C 80 80 29 */	lis r4, lbl_sPadData@ha
/* 800CAC58 000C7A58  38 C4 26 20 */	addi r6, r4, lbl_sPadData@l
...
/* 800CAC70 000C7A70  48 00 01 C9 */	bl iPad.iPadConvFromGCN__FUiUiUi
/* 800CAC74 000C7A74  A8 1D 00 54 */	lha r0, 0x54(r29)
/* 800CAC78 000C7A78  3C 80 80 29 */	lis r4, lbl_sPadData@ha
/* 800CAC7C 000C7A7C  38 C4 26 20 */	addi r6, r4, lbl_sPadData@l
...
/* 800CAC94 000C7A94  48 00 01 A5 */	bl iPad.iPadConvFromGCN__FUiUiUi
/* 800CAC98 000C7A98  A8 1D 00 54 */	lha r0, 0x54(r29)
/* 800CAC9C 000C7A9C  3C 80 80 29 */	lis r4, lbl_sPadData@ha
/* 800CACA0 000C7AA0  38 C4 26 20 */	addi r6, r4, lbl_sPadData@l
...
/* 800CACB8 000C7AB8  48 00 01 81 */	bl iPad.iPadConvFromGCN__FUiUiUi
/* 800CACBC 000C7ABC  A8 1D 00 54 */	lha r0, 0x54(r29)
/* 800CACC0 000C7AC0  3C 80 80 29 */	lis r4, lbl_sPadData@ha
/* 800CACC4 000C7AC4  38 C4 26 20 */	addi r6, r4, lbl_sPadData@l
...
/* 800CACDC 000C7ADC  48 00 01 5D */	bl iPad.iPadConvFromGCN__FUiUiUi
/* 800CACE0 000C7AE0  7F FF 1B 78 */	or r31, r31, r3
/* 800CACE4 000C7AE4  3C 60 80 29 */	lis r3, lbl_sPadData@ha
/* 800CACE8 000C7AE8  93 FE 00 00 */	stw r31, 0(r30)
/* 800CACEC 000C7AEC  3C 00 43 30 */	lis r0, 0x4330
/* 800CACF0 000C7AF0  38 83 26 20 */	addi r4, r3, lbl_sPadData@l
...
/* 800CAD00 000C7B00  C8 22 97 B0 */	lfd f1, lbl__719_1-_SDA2_BASE_(r2)
...
/* 800CAD20 000C7B20  4B FF FC 6D */	bl iPad.iPadConvStick__Ff
/* 800CAD24 000C7B24  98 7D 00 38 */	stb r3, 0x38(r29)
/* 800CAD28 000C7B28  3C 80 80 29 */	lis r4, lbl_sPadData@ha
/* 800CAD2C 000C7B2C  3C 00 43 30 */	lis r0, 0x4330
/* 800CAD30 000C7B30  A8 7D 00 54 */	lha r3, 0x54(r29)
/* 800CAD34 000C7B34  38 84 26 20 */	addi r4, r4, lbl_sPadData@l
/* 800CAD38 000C7B38  90 01 00 10 */	stw r0, 0x10(r1)
/* 800CAD3C 000C7B3C  1C 03 00 0C */	mulli r0, r3, 0xc
/* 800CAD40 000C7B40  C8 22 97 B0 */	lfd f1, lbl__719_1-_SDA2_BASE_(r2)
...
/* 800CAD60 000C7B60  4B FF FC 2D */	bl iPad.iPadConvStick__Ff
/* 800CAD64 000C7B64  7C 03 00 D0 */	neg r0, r3
/* 800CAD68 000C7B68  3C 60 80 29 */	lis r3, lbl_sPadData@ha
/* 800CAD6C 000C7B6C  98 1D 00 39 */	stb r0, 0x39(r29)
/* 800CAD70 000C7B70  38 83 26 20 */	addi r4, r3, lbl_sPadData@l
...
/* 800CAD84 000C7B84  C8 22 97 B0 */	lfd f1, lbl__719_1-_SDA2_BASE_(r2)
...
/* 800CADA4 000C7BA4  4B FF FB E9 */	bl iPad.iPadConvStick__Ff
/* 800CADA8 000C7BA8  98 7D 00 3A */	stb r3, 0x3a(r29)
/* 800CADAC 000C7BAC  3C 80 80 29 */	lis r4, lbl_sPadData@ha
/* 800CADB0 000C7BB0  3C 00 43 30 */	lis r0, 0x4330
/* 800CADB4 000C7BB4  A8 7D 00 54 */	lha r3, 0x54(r29)
/* 800CADB8 000C7BB8  38 84 26 20 */	addi r4, r4, lbl_sPadData@l
/* 800CADBC 000C7BBC  90 01 00 20 */	stw r0, 0x20(r1)
/* 800CADC0 000C7BC0  1C 03 00 0C */	mulli r0, r3, 0xc
/* 800CADC4 000C7BC4  C8 22 97 B0 */	lfd f1, lbl__719_1-_SDA2_BASE_(r2)
...
/* 800CADE4 000C7BE4  4B FF FB A9 */	bl iPad.iPadConvStick__Ff
/* 800CADE8 000C7BE8  7C 03 00 D0 */	neg r0, r3
/* 800CADEC 000C7BEC  3C 60 80 3C */	lis r3, lbl_gTrcPad@ha
/* 800CADF0 000C7BF0  98 1D 00 3B */	stb r0, 0x3b(r29)
/* 800CADF4 000C7BF4  38 83 EF 88 */	addi r4, r3, lbl_gTrcPad@l
...
.global iPad.iPadConvFromGCN__FUiUiUi
iPad.iPadConvFromGCN__FUiUiUi:
...
/* 800CAE84 000C7C84  3C 80 80 3C */	lis r4, lbl_globals@ha
/* 800CAE88 000C7C88  3C 60 80 39 */	lis r3, lbl_mPad@ha
/* 800CAE8C 000C7C8C  90 01 00 14 */	stw r0, 0x14(r1)
/* 800CAE90 000C7C90  38 A4 05 58 */	addi r5, r4, lbl_globals@l
/* 800CAE94 000C7C94  38 03 C9 94 */	addi r0, r3, lbl_mPad@l
