...
lbl_80122C04:
/* 80122C04 0011FA04  80 AD 95 3C */	lwz r5, lbl_sAtomicStartCount-_SDA_BASE_(r13)
/* 80122C08 0011FA08  38 05 00 01 */	addi r0, r5, 1
/* 80122C0C 0011FA0C  90 0D 95 3C */	stw r0, lbl_sAtomicStartCount-_SDA_BASE_(r13)
...
/* 80122C60 0011FA60  80 8D 95 38 */	lwz r4, lbl_sCurrVert-_SDA_BASE_(r13)
...
/* 80122CD4 0011FAD4  80 CD 95 3C */	lwz r6, lbl_sAtomicStartCount-_SDA_BASE_(r13)
...
/* 80122CE4 0011FAE4  80 CD 95 40 */	lwz r6, lbl_sAtomicStartVert-_SDA_BASE_(r13)
/* 80122CE8 0011FAE8  38 84 2C 2C */	addi r4, r4, lbl_80122C2C@l
/* 80122CEC 0011FAEC  90 0D 95 3C */	stw r0, lbl_sAtomicStartCount-_SDA_BASE_(r13)
...
/* 80122D04 0011FB04  90 0D 95 38 */	stw r0, lbl_sCurrVert-_SDA_BASE_(r13)
...
lbl_80122D2C:
/* 80122D2C 0011FB2C  80 AD 95 3C */	lwz r5, lbl_sAtomicStartCount-_SDA_BASE_(r13)
/* 80122D30 0011FB30  80 E4 00 00 */	lwz r7, 0(r4)
/* 80122D34 0011FB34  38 A5 FF FF */	addi r5, r5, -1
/* 80122D38 0011FB38  80 CD 95 40 */	lwz r6, lbl_sAtomicStartVert-_SDA_BASE_(r13)
/* 80122D3C 0011FB3C  54 A0 10 3A */	slwi r0, r5, 2
/* 80122D40 0011FB40  90 AD 95 3C */	stw r5, lbl_sAtomicStartCount-_SDA_BASE_(r13)
...
/* 80122DA8 0011FBA8  80 8D 9F 7C */	lwz r4, lbl_RwEngineInstance-_SDA_BASE_(r13)
...
/* 80122DE0 0011FBE0  48 0C 0D 91 */	bl func_801E3B70
...
/* 80122E30 0011FC30  48 0C 0D 41 */	bl func_801E3B70
...
/* 80122E50 0011FC50  48 0C 48 6D */	bl func_801E76BC
...
/* 80122EE0 0011FCE0  48 0C 0C 91 */	bl func_801E3B70
...
/* 80122F18 0011FD18  90 6D 95 3C */	stw r3, lbl_sAtomicStartCount-_SDA_BASE_(r13)
/* 80122F1C 0011FD1C  80 6D 9F 7C */	lwz r3, lbl_RwEngineInstance-_SDA_BASE_(r13)
/* 80122F20 0011FD20  80 0D 95 3C */	lwz r0, lbl_sAtomicStartCount-_SDA_BASE_(r13)
...
/* 80122F34 0011FD34  90 6D 95 40 */	stw r3, lbl_sAtomicStartVert-_SDA_BASE_(r13)
...
/* 80122F74 0011FD74  90 0D 95 3C */	stw r0, lbl_sAtomicStartCount-_SDA_BASE_(r13)
/* 80122F78 0011FD78  80 7D 00 0C */	lwz r3, 0xc(r29)
/* 80122F7C 0011FD7C  48 0F 00 B5 */	bl RpClumpForAllAtomics
/* 80122F80 0011FD80  80 6D 9F 7C */	lwz r3, lbl_RwEngineInstance-_SDA_BASE_(r13)
...
/* 80122F9C 0011FD9C  80 6D 9F 7C */	lwz r3, lbl_RwEngineInstance-_SDA_BASE_(r13)
/* 80122FA0 0011FDA0  80 0D 95 3C */	lwz r0, lbl_sAtomicStartCount-_SDA_BASE_(r13)
...
/* 80122FB4 0011FDB4  90 6D 95 40 */	stw r3, lbl_sAtomicStartVert-_SDA_BASE_(r13)
...
/* 80122FE8 0011FDE8  80 8D 95 40 */	lwz r4, lbl_sAtomicStartVert-_SDA_BASE_(r13)
...
/* 8012301C 0011FE1C  80 8D 9F 7C */	lwz r4, lbl_RwEngineInstance-_SDA_BASE_(r13)
/* 80123020 0011FE20  80 6D 95 40 */	lwz r3, lbl_sAtomicStartVert-_SDA_BASE_(r13)
...
/* 801230A0 0011FEA0  80 8D 9F 7C */	lwz r4, lbl_RwEngineInstance-_SDA_BASE_(r13)
...
/* 80123118 0011FF18  80 8D 9F 7C */	lwz r4, lbl_RwEngineInstance-_SDA_BASE_(r13)
...
/* 80123150 0011FF50  3C 80 80 3C */	lis r4, lbl_globals@ha
...
/* 80123164 0011FF64  3B C4 05 58 */	addi r30, r4, lbl_globals@l
...
/* 801231AC 0011FFAC  80 8D 9F 7C */	lwz r4, lbl_RwEngineInstance-_SDA_BASE_(r13)
...
/* 801231E8 0011FFE8  80 8D 9F 7C */	lwz r4, lbl_RwEngineInstance-_SDA_BASE_(r13)
...
lbl_801231FC:
/* 801231FC 0011FFFC  80 8D 9F 7C */	lwz r4, lbl_RwEngineInstance-_SDA_BASE_(r13)
