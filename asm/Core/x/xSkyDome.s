...
/* 8010EEE0 0010BCE0  90 0D 94 E8 */	stw r0, lbl_sSkyCount-_SDA_BASE_(r13)
...
/* 8010EEF0 0010BCF0  3C C0 80 31 */	lis r6, lbl_sSkyList@ha
/* 8010EEF4 0010BCF4  90 01 00 34 */	stw r0, 0x34(r1)
/* 8010EEF8 0010BCF8  38 C6 37 28 */	addi r6, r6, lbl_sSkyList@l
...
/* 8010EF14 0010BD14  80 ED 94 E8 */	lwz r7, lbl_sSkyCount-_SDA_BASE_(r13)
...
/* 8010EF64 0010BD64  3C 60 80 31 */	lis r3, lbl_sSkyList@ha
/* 8010EF68 0010BD68  1C 19 00 0C */	mulli r0, r25, 0xc
/* 8010EF6C 0010BD6C  3B 83 37 28 */	addi r28, r3, lbl_sSkyList@l
...
/* 8010EFA0 0010BDA0  3C 80 80 31 */	lis r4, lbl_sSkyList@ha
/* 8010EFA4 0010BDA4  3C 60 80 11 */	lis r3, lbl_8010EED8@ha
/* 8010EFA8 0010BDA8  38 84 37 28 */	addi r4, r4, lbl_sSkyList@l
...
/* 8010EFC8 0010BDC8  80 AD 94 E8 */	lwz r5, lbl_sSkyCount-_SDA_BASE_(r13)
/* 8010EFCC 0010BDCC  38 A5 00 01 */	addi r5, r5, 1
/* 8010EFD0 0010BDD0  90 AD 94 E8 */	stw r5, lbl_sSkyCount-_SDA_BASE_(r13)
...
/* 8010F03C 0010BE3C  3C 60 80 31 */	lis r3, lbl_sSkyList@ha
/* 8010F040 0010BE40  90 01 00 34 */	stw r0, 0x34(r1)
/* 8010F044 0010BE44  BF 61 00 1C */	stmw r27, 0x1c(r1)
/* 8010F048 0010BE48  3B A3 37 28 */	addi r29, r3, lbl_sSkyList@l
...
/* 8010F058 0010BE58  80 8D 9F 7C */	lwz r4, lbl_RwEngineInstance-_SDA_BASE_(r13)
...
lbl_8010F130:
/* 8010F130 0010BF30  80 0D 94 E8 */	lwz r0, lbl_sSkyCount-_SDA_BASE_(r13)
