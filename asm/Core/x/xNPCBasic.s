...
/* 8010F848 0010C648  C0 22 9E 50 */	lfs f1, lbl__705_2-_SDA2_BASE_(r2)
...
/* 8010F858 0010C658  C0 02 9E 54 */	lfs f0, lbl__706_3-_SDA2_BASE_(r2)
/* 8010F85C 0010C65C  D0 1E 00 2C */	stfs f0, 0x2c(r30)
lbl_8010F860:
/* 8010F860 0010C660  C0 22 9E 50 */	lfs f1, lbl__705_2-_SDA2_BASE_(r2)
...
/* 8010F870 0010C670  C0 02 9E 54 */	lfs f0, lbl__706_3-_SDA2_BASE_(r2)
/* 8010F874 0010C674  D0 1E 00 30 */	stfs f0, 0x30(r30)
lbl_8010F878:
/* 8010F878 0010C678  C0 22 9E 50 */	lfs f1, lbl__705_2-_SDA2_BASE_(r2)
...
/* 8010F888 0010C688  C0 02 9E 54 */	lfs f0, lbl__706_3-_SDA2_BASE_(r2)
...
/* 8010F954 0010C754  80 6D 89 E0 */	lwz r3, lbl_gActiveHeap-_SDA_BASE_(r13)
...
/* 8010F984 0010C784  80 6D 89 E0 */	lwz r3, lbl_gActiveHeap-_SDA_BASE_(r13)
...
/* 8010FA58 0010C858  3C 60 80 25 */	lis r3, lbl_g_Y3@ha
/* 8010FA5C 0010C85C  38 83 30 30 */	addi r4, r3, lbl_g_Y3@l
/* 8010FA60 0010C860  38 65 00 9C */	addi r3, r5, 0x9c
/* 8010FA64 0010C864  4B F3 EA 79 */	bl xVec3Copy__FP5xVec3PC5xVec3
/* 8010FA68 0010C868  C0 02 9E 50 */	lfs f0, lbl__705_2-_SDA2_BASE_(r2)
/* 8010FA6C 0010C86C  3C 60 80 25 */	lis r3, lbl_g_Y3@ha
/* 8010FA70 0010C870  80 BF 00 48 */	lwz r5, 0x48(r31)
/* 8010FA74 0010C874  38 83 30 30 */	addi r4, r3, lbl_g_Y3@l
...
/* 8010FAB0 0010C8B0  C0 02 9E 60 */	lfs f0, lbl__721_1-_SDA2_BASE_(r2)
/* 8010FAB4 0010C8B4  7F E3 FB 78 */	mr r3, r31
/* 8010FAB8 0010C8B8  C0 42 9E 5C */	lfs f2, lbl__720_1-_SDA2_BASE_(r2)
/* 8010FABC 0010C8BC  EC 21 00 28 */	fsubs f1, f1, f0
/* 8010FAC0 0010C8C0  C0 02 9E 58 */	lfs f0, lbl__719_2-_SDA2_BASE_(r2)
...
/* 8010FAFC 0010C8FC  3C 80 80 27 */	lis r4, lbl__727_2@ha
/* 8010FB00 0010C900  90 01 00 24 */	stw r0, 0x24(r1)
/* 8010FB04 0010C904  38 C4 A3 F8 */	addi r6, r4, lbl__727_2@l
...
/* 8010FB40 0010C940  C0 02 9E 64 */	lfs f0, lbl__738-_SDA2_BASE_(r2)
...
/* 8010FB5C 0010C95C  C0 02 9E 64 */	lfs f0, lbl__738-_SDA2_BASE_(r2)
...
lbl_8010FBB4:
/* 8010FBB4 0010C9B4  80 02 81 A8 */	lwz r0, lbl_g_PIMP_GOLD-_SDA2_BASE_(r2)
...
.global xNPCBasic.NPC_spdBasedColFreq__FP9xNPCBasicf
xNPCBasic.NPC_spdBasedColFreq__FP9xNPCBasicf:
...
/* 8010FBF4 0010C9F4  C0 02 9E 68 */	lfs f0, lbl__770_2-_SDA2_BASE_(r2)
...
/* 8010FC0C 0010CA0C  C0 02 9E 6C */	lfs f0, lbl__771_2-_SDA2_BASE_(r2)
...
/* 8010FC5C 0010CA5C  C0 22 9E 70 */	lfs f1, lbl__772_3-_SDA2_BASE_(r2)
...
/* 8010FD8C 0010CB8C  C0 02 9E 50 */	lfs f0, lbl__705_2-_SDA2_BASE_(r2)
...
/* 8010FDAC 0010CBAC  C0 02 9E 50 */	lfs f0, lbl__705_2-_SDA2_BASE_(r2)
...
/* 8010FDCC 0010CBCC  C0 02 9E 50 */	lfs f0, lbl__705_2-_SDA2_BASE_(r2)
...
/* 8010FDEC 0010CBEC  C0 02 9E 50 */	lfs f0, lbl__705_2-_SDA2_BASE_(r2)
...
/* 8010FE68 0010CC68  3C 60 80 29 */	lis r3, lbl_g_colrec@ha
/* 8010FE6C 0010CC6C  38 80 00 00 */	li r4, 0
/* 8010FE70 0010CC70  38 63 74 60 */	addi r3, r3, lbl_g_colrec@l
/* 8010FE74 0010CC74  38 A0 05 B4 */	li r5, 0x5b4
/* 8010FE78 0010CC78  4B EF 35 E1 */	bl memset
/* 8010FE7C 0010CC7C  3C 60 80 29 */	lis r3, lbl_g_colrec@ha
/* 8010FE80 0010CC80  38 03 74 60 */	addi r0, r3, lbl_g_colrec@l
...
/* 8010FF1C 0010CD1C  C0 02 9E 74 */	lfs f0, lbl__856_1-_SDA2_BASE_(r2)
...
/* 8010FF30 0010CD30  4B FF FC B1 */	bl xNPCBasic.NPC_spdBasedColFreq__FP9xNPCBasicf
lbl_8010FF34:
...
/* 8010FF60 0010CD60  80 02 81 88 */	lwz r0, lbl_g_BLUE-_SDA2_BASE_(r2)
...
/* 8010FFC4 0010CDC4  80 02 81 B0 */	lwz r0, lbl_g_LAVENDER-_SDA2_BASE_(r2)
...
/* 801100AC 0010CEAC  C0 02 9E 7C */	lfs f0, lbl__914-_SDA2_BASE_(r2)
...
/* 801100C4 0010CEC4  C3 E2 9E 78 */	lfs f31, lbl__913-_SDA2_BASE_(r2)
lbl_801100C8:
