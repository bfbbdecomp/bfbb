...
/* 80043EC0 00040CC0  38 6D 80 A0 */	addi r3, r13, lbl_s_managedEnvSFX-_SDA_BASE_
...
/* 80043F18 00040D18  48 00 03 55 */	bl xSFX.xSFXUpdate__FP4xSFX
...
/* 80043F2C 00040D2C  38 6D 8A A8 */	addi r3, r13, lbl_bestSFX$773-_SDA_BASE_
/* 80043F30 00040D30  38 80 00 00 */	li r4, 0
/* 80043F34 00040D34  38 A0 00 04 */	li r5, 4
/* 80043F38 00040D38  4B FB F5 21 */	bl memset
/* 80043F3C 00040D3C  3C 60 80 3C */	lis r3, lbl_gSnd@ha
/* 80043F40 00040D40  3B C0 00 00 */	li r30, 0
/* 80043F44 00040D44  38 63 D5 B4 */	addi r3, r3, lbl_gSnd@l
...
/* 80043FB0 00040DB0  38 AD 8A A8 */	addi r5, r13, lbl_bestSFX$773-_SDA_BASE_
/* 80043FB4 00040DB4  38 00 00 00 */	li r0, 0
/* 80043FB8 00040DB8  80 6D 8A A8 */	lwz r3, lbl_bestSFX$773-_SDA_BASE_(r13)
...
/* 80043FC8 00040DC8  38 6D 8A AC */	addi r3, r13, lbl_bestDist2$774-_SDA_BASE_
...
/* 80043FF8 00040DF8  38 6D 8A AC */	addi r3, r13, lbl_bestDist2$774-_SDA_BASE_
...
/* 80044010 00040E10  38 6D 8A AC */	addi r3, r13, lbl_bestDist2$774-_SDA_BASE_
...
/* 80044040 00040E40  3B 8D 80 A0 */	addi r28, r13, lbl_s_managedEnvSFX-_SDA_BASE_
/* 80044044 00040E44  38 8D 8A A8 */	addi r4, r13, lbl_bestSFX$773-_SDA_BASE_
/* 80044048 00040E48  80 6D 80 A0 */	lwz r3, lbl_s_managedEnvSFX-_SDA_BASE_(r13)
/* 8004404C 00040E4C  38 A0 00 00 */	li r5, 0
/* 80044050 00040E50  80 0D 8A A8 */	lwz r0, lbl_bestSFX$773-_SDA_BASE_(r13)
...
/* 80044084 00040E84  48 00 06 BD */	bl xSFX.xSFXStop__FP4xSFX
/* 80044088 00040E88  38 00 00 00 */	li r0, 0
/* 8004408C 00040E8C  90 1C 00 00 */	stw r0, 0(r28)
lbl_80044090:
/* 80044090 00040E90  38 8D 8A A8 */	addi r4, r13, lbl_bestSFX$773-_SDA_BASE_
/* 80044094 00040E94  38 6D 80 A0 */	addi r3, r13, lbl_s_managedEnvSFX-_SDA_BASE_
/* 80044098 00040E98  80 AD 8A A8 */	lwz r5, lbl_bestSFX$773-_SDA_BASE_(r13)
...
/* 800440C0 00040EC0  48 00 03 65 */	bl xSFX.xSFXPlay__FP4xSFX
lbl_800440C4:
...
.global xSFX.xSFXWillSendDone__FP4xSFX
xSFX.xSFXWillSendDone__FP4xSFX:
...
/* 8004419C 00040F9C  4B FF FF 49 */	bl xSFX.xSFXWillSendDone__FP4xSFX
...
.global xSFX.xSFXUpdate__FP4xSFX
xSFX.xSFXUpdate__FP4xSFX:
...
/* 8004430C 0004110C  3C 60 80 29 */	lis r3, lbl__964_2@ha
/* 80044310 00041110  54 00 10 3A */	slwi r0, r0, 2
/* 80044314 00041114  38 63 8C 38 */	addi r3, r3, lbl__964_2@l
...
/* 80044354 00041154  48 00 00 D1 */	bl xSFX.xSFXPlay__FP4xSFX
...
/* 80044374 00041174  C8 42 86 68 */	lfd f2, lbl__966-_SDA2_BASE_(r2)
...
/* 800443C4 000411C4  48 00 00 61 */	bl xSFX.xSFXPlay__FP4xSFX
...
/* 800443FC 000411FC  48 00 03 45 */	bl xSFX.xSFXStop__FP4xSFX
...
.global xSFX.xSFXPlay__FP4xSFX
xSFX.xSFXPlay__FP4xSFX:
...
/* 800444AC 000412AC  C8 42 86 68 */	lfd f2, lbl__966-_SDA2_BASE_(r2)
/* 800444B0 000412B0  C8 21 00 20 */	lfd f1, 0x20(r1)
/* 800444B4 000412B4  C0 02 86 74 */	lfs f0, lbl__1002_1-_SDA2_BASE_(r2)
/* 800444B8 000412B8  EC 21 10 28 */	fsubs f1, f1, f2
/* 800444BC 000412BC  90 01 00 2C */	stw r0, 0x2c(r1)
/* 800444C0 000412C0  C0 A2 86 70 */	lfs f5, lbl__1001_1-_SDA2_BASE_(r2)
...
/* 800444F0 000412F0  C0 A2 86 78 */	lfs f5, lbl__1003-_SDA2_BASE_(r2)
...
/* 80044560 00041360  C8 42 86 68 */	lfd f2, lbl__966-_SDA2_BASE_(r2)
/* 80044564 00041364  C8 21 00 28 */	lfd f1, 0x28(r1)
/* 80044568 00041368  C0 02 86 74 */	lfs f0, lbl__1002_1-_SDA2_BASE_(r2)
/* 8004456C 0004136C  EC 21 10 28 */	fsubs f1, f1, f2
/* 80044570 00041370  90 01 00 24 */	stw r0, 0x24(r1)
/* 80044574 00041374  C0 C2 86 70 */	lfs f6, lbl__1001_1-_SDA2_BASE_(r2)
...
/* 800445A0 000413A0  C0 A2 86 78 */	lfs f5, lbl__1003-_SDA2_BASE_(r2)
...
/* 800445D8 000413D8  C8 42 86 68 */	lfd f2, lbl__966-_SDA2_BASE_(r2)
/* 800445DC 000413DC  C8 21 00 28 */	lfd f1, 0x28(r1)
/* 800445E0 000413E0  C0 02 86 74 */	lfs f0, lbl__1002_1-_SDA2_BASE_(r2)
/* 800445E4 000413E4  EC 21 10 28 */	fsubs f1, f1, f2
/* 800445E8 000413E8  90 01 00 24 */	stw r0, 0x24(r1)
/* 800445EC 000413EC  C0 C2 86 70 */	lfs f6, lbl__1001_1-_SDA2_BASE_(r2)
...
/* 80044618 00041418  C0 A2 86 78 */	lfs f5, lbl__1003-_SDA2_BASE_(r2)
...
/* 80044644 00041444  C8 A2 86 68 */	lfd f5, lbl__966-_SDA2_BASE_(r2)
/* 80044648 00041448  38 E0 00 00 */	li r7, 0
/* 8004464C 0004144C  90 61 00 28 */	stw r3, 0x28(r1)
/* 80044650 00041450  C0 22 86 74 */	lfs f1, lbl__1002_1-_SDA2_BASE_(r2)
...
/* 80044660 00041460  C0 E2 86 70 */	lfs f7, lbl__1001_1-_SDA2_BASE_(r2)
...
/* 80044688 00041488  C0 A2 86 78 */	lfs f5, lbl__1003-_SDA2_BASE_(r2)
...
/* 800446B8 000414B8  C8 A2 86 68 */	lfd f5, lbl__966-_SDA2_BASE_(r2)
/* 800446BC 000414BC  38 E0 00 00 */	li r7, 0
/* 800446C0 000414C0  90 61 00 28 */	stw r3, 0x28(r1)
/* 800446C4 000414C4  C0 22 86 74 */	lfs f1, lbl__1002_1-_SDA2_BASE_(r2)
...
/* 800446D4 000414D4  C0 C2 86 70 */	lfs f6, lbl__1001_1-_SDA2_BASE_(r2)
...
/* 800446F0 000414F0  C0 62 86 78 */	lfs f3, lbl__1003-_SDA2_BASE_(r2)
...
.global xSFX.xSFXStop__FP4xSFX
xSFX.xSFXStop__FP4xSFX:
