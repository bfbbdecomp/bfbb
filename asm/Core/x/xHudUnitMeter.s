...
/* 8002FFF4 0002CDF4  3C 60 80 28 */	lis r3, lbl___vt__Q24xhud17unit_meter_widget@ha
/* 8002FFF8 0002CDF8  38 00 00 12 */	li r0, 0x12
/* 8002FFFC 0002CDFC  38 63 D6 C8 */	addi r3, r3, lbl___vt__Q24xhud17unit_meter_widget@l
...
/* 80030038 0002CE38  C0 02 84 70 */	lfs f0, lbl__692-_SDA2_BASE_(r2)
...
/* 80030080 0002CE80  88 0D 89 C1 */	lbz r0, lbl_init$682-_SDA_BASE_(r13)
...
/* 80030094 0002CE94  98 6D 89 C0 */	stb r3, lbl_registered$681-_SDA_BASE_(r13)
/* 80030098 0002CE98  98 0D 89 C1 */	stb r0, lbl_init$682-_SDA_BASE_(r13)
lbl_8003009C:
/* 8003009C 0002CE9C  88 0D 89 C0 */	lbz r0, lbl_registered$681-_SDA_BASE_(r13)
...
/* 800300AC 0002CEAC  3C 60 80 25 */	lis r3, lbl__stringBase0_13@ha
/* 800300B0 0002CEB0  98 0D 89 C0 */	stb r0, lbl_registered$681-_SDA_BASE_(r13)
/* 800300B4 0002CEB4  38 63 2F 90 */	addi r3, r3, lbl__stringBase0_13@l
/* 800300B8 0002CEB8  38 8D 80 80 */	addi r4, r13, lbl_tweak_anim_time_delta__Q24xhud27_unnamed_xHudUnitMeter_cpp_-_SDA_BASE_
/* 800300BC 0002CEBC  38 A0 00 00 */	li r5, 0
/* 800300C0 0002CEC0  C0 22 84 70 */	lfs f1, lbl__692-_SDA2_BASE_(r2)
/* 800300C4 0002CEC4  38 C0 00 00 */	li r6, 0
/* 800300C8 0002CEC8  C0 42 84 74 */	lfs f2, lbl__693_1-_SDA2_BASE_(r2)
...
/* 80030138 0002CF38  88 0D 89 C8 */	lbz r0, lbl_init$712-_SDA_BASE_(r13)
...
/* 8003014C 0002CF4C  90 6D 89 C4 */	stw r3, lbl_myid$711-_SDA_BASE_(r13)
/* 80030150 0002CF50  38 00 00 01 */	li r0, 1
/* 80030154 0002CF54  98 0D 89 C8 */	stb r0, lbl_init$712-_SDA_BASE_(r13)
lbl_80030158:
/* 80030158 0002CF58  80 01 00 14 */	lwz r0, 0x14(r1)
/* 8003015C 0002CF5C  80 6D 89 C4 */	lwz r3, lbl_myid$711-_SDA_BASE_(r13)
...
/* 8003022C 0002D02C  C0 02 84 78 */	lfs f0, lbl__756-_SDA2_BASE_(r2)
...
/* 8003024C 0002D04C  C0 22 84 7C */	lfs f1, lbl__757-_SDA2_BASE_(r2)
...
/* 8003029C 0002D09C  C8 22 84 80 */	lfd f1, lbl__759-_SDA2_BASE_(r2)
...
/* 800302D4 0002D0D4  C8 22 84 80 */	lfd f1, lbl__759-_SDA2_BASE_(r2)
...
/* 8003031C 0002D11C  C0 02 84 70 */	lfs f0, lbl__692-_SDA2_BASE_(r2)
...
/* 80030344 0002D144  C8 82 84 80 */	lfd f4, lbl__759-_SDA2_BASE_(r2)
/* 80030348 0002D148  90 01 00 08 */	stw r0, 8(r1)
/* 8003034C 0002D14C  C0 2D 80 80 */	lfs f1, lbl_tweak_anim_time_delta__Q24xhud27_unnamed_xHudUnitMeter_cpp_-_SDA_BASE_(r13)
...
/* 80030478 0002D278  C0 22 84 7C */	lfs f1, lbl__757-_SDA2_BASE_(r2)
...
/* 800304C8 0002D2C8  C8 22 84 80 */	lfd f1, lbl__759-_SDA2_BASE_(r2)
...
/* 80030500 0002D300  C8 22 84 80 */	lfd f1, lbl__759-_SDA2_BASE_(r2)
...
/* 80030548 0002D348  C8 82 84 80 */	lfd f4, lbl__759-_SDA2_BASE_(r2)
...
/* 80030630 0002D430  3C 60 80 25 */	lis r3, lbl__stringBase0_13@ha
/* 80030634 0002D434  38 63 2F 90 */	addi r3, r3, lbl__stringBase0_13@l
