...
/* 8001F8D0 0001C6D0  90 6D 88 E8 */	stw r3, lbl_psize-_SDA_BASE_(r13)
/* 8001F8D4 0001C6D4  80 6D 89 E0 */	lwz r3, lbl_gActiveHeap-_SDA_BASE_(r13)
/* 8001F8D8 0001C6D8  48 01 40 69 */	bl xMemAlloc__FUiUii
/* 8001F8DC 0001C6DC  90 6D 88 EC */	stw r3, lbl_pool-_SDA_BASE_(r13)
/* 8001F8E0 0001C6E0  38 00 00 00 */	li r0, 0
/* 8001F8E4 0001C6E4  38 C0 00 01 */	li r6, 1
/* 8001F8E8 0001C6E8  38 80 00 10 */	li r4, 0x10
/* 8001F8EC 0001C6EC  80 6D 88 EC */	lwz r3, lbl_pool-_SDA_BASE_(r13)
...
/* 8001F8FC 0001C6FC  80 AD 88 EC */	lwz r5, lbl_pool-_SDA_BASE_(r13)
...
lbl_8001F918:
/* 8001F918 0001C718  80 6D 88 E8 */	lwz r3, lbl_psize-_SDA_BASE_(r13)
...
/* 8001F928 0001C728  80 6D 88 EC */	lwz r3, lbl_pool-_SDA_BASE_(r13)
/* 8001F92C 0001C72C  54 00 20 36 */	slwi r0, r0, 4
/* 8001F930 0001C730  7C 03 02 14 */	add r0, r3, r0
/* 8001F934 0001C734  90 0D 88 F0 */	stw r0, lbl_alist-_SDA_BASE_(r13)
...
xFFXAlloc__Fv:
/* 8001F948 0001C748  80 6D 88 F0 */	lwz r3, lbl_alist-_SDA_BASE_(r13)
...
/* 8001F960 0001C760  90 0D 88 F0 */	stw r0, lbl_alist-_SDA_BASE_(r13)
/* 8001F964 0001C764  4E 80 00 20 */	blr 

.global xFFXFree__FP4xFFX
xFFXFree__FP4xFFX:
/* 8001F968 0001C768  80 0D 88 F0 */	lwz r0, lbl_alist-_SDA_BASE_(r13)
/* 8001F96C 0001C76C  90 03 00 0C */	stw r0, 0xc(r3)
/* 8001F970 0001C770  90 6D 88 F0 */	stw r3, lbl_alist-_SDA_BASE_(r13)
...
/* 8001FBAC 0001C9AC  C0 42 82 C8 */	lfs f2, lbl__701-_SDA2_BASE_(r2)
...
/* 8001FC68 0001CA68  90 6D 88 F4 */	stw r3, lbl_shake_psize-_SDA_BASE_(r13)
/* 8001FC6C 0001CA6C  80 6D 89 E0 */	lwz r3, lbl_gActiveHeap-_SDA_BASE_(r13)
/* 8001FC70 0001CA70  48 01 3C D1 */	bl xMemAlloc__FUiUii
/* 8001FC74 0001CA74  90 6D 88 F8 */	stw r3, lbl_shake_pool-_SDA_BASE_(r13)
/* 8001FC78 0001CA78  38 00 00 00 */	li r0, 0
/* 8001FC7C 0001CA7C  38 C0 00 01 */	li r6, 1
/* 8001FC80 0001CA80  38 80 00 24 */	li r4, 0x24
/* 8001FC84 0001CA84  80 6D 88 F8 */	lwz r3, lbl_shake_pool-_SDA_BASE_(r13)
...
/* 8001FC9C 0001CA9C  80 AD 88 F8 */	lwz r5, lbl_shake_pool-_SDA_BASE_(r13)
...
lbl_8001FCB0:
/* 8001FCB0 0001CAB0  80 6D 88 F4 */	lwz r3, lbl_shake_psize-_SDA_BASE_(r13)
...
/* 8001FCC0 0001CAC0  80 6D 88 F8 */	lwz r3, lbl_shake_pool-_SDA_BASE_(r13)
/* 8001FCC4 0001CAC4  1C 00 00 24 */	mulli r0, r0, 0x24
/* 8001FCC8 0001CAC8  7C 03 02 14 */	add r0, r3, r0
/* 8001FCCC 0001CACC  90 0D 88 FC */	stw r0, lbl_shake_alist-_SDA_BASE_(r13)
...
xFFXShakeAlloc__Fv:
/* 8001FCE0 0001CAE0  80 6D 88 FC */	lwz r3, lbl_shake_alist-_SDA_BASE_(r13)
...
/* 8001FCF8 0001CAF8  90 0D 88 FC */	stw r0, lbl_shake_alist-_SDA_BASE_(r13)
/* 8001FCFC 0001CAFC  4E 80 00 20 */	blr 

.global xFFXShakeFree__FP14xFFXShakeState
xFFXShakeFree__FP14xFFXShakeState:
/* 8001FD00 0001CB00  80 0D 88 FC */	lwz r0, lbl_shake_alist-_SDA_BASE_(r13)
/* 8001FD04 0001CB04  90 03 00 20 */	stw r0, 0x20(r3)
/* 8001FD08 0001CB08  90 6D 88 FC */	stw r3, lbl_shake_alist-_SDA_BASE_(r13)
...
/* 8001FD24 0001CB24  90 6D 89 00 */	stw r3, lbl_rot_match_psize-_SDA_BASE_(r13)
/* 8001FD28 0001CB28  80 6D 89 E0 */	lwz r3, lbl_gActiveHeap-_SDA_BASE_(r13)
/* 8001FD2C 0001CB2C  48 01 3C 15 */	bl xMemAlloc__FUiUii
/* 8001FD30 0001CB30  90 6D 89 04 */	stw r3, lbl_rot_match_pool-_SDA_BASE_(r13)
/* 8001FD34 0001CB34  38 00 00 00 */	li r0, 0
/* 8001FD38 0001CB38  38 C0 00 01 */	li r6, 1
/* 8001FD3C 0001CB3C  38 80 00 44 */	li r4, 0x44
/* 8001FD40 0001CB40  80 6D 89 04 */	lwz r3, lbl_rot_match_pool-_SDA_BASE_(r13)
...
/* 8001FD58 0001CB58  80 AD 89 04 */	lwz r5, lbl_rot_match_pool-_SDA_BASE_(r13)
...
lbl_8001FD6C:
/* 8001FD6C 0001CB6C  80 6D 89 00 */	lwz r3, lbl_rot_match_psize-_SDA_BASE_(r13)
...
/* 8001FD7C 0001CB7C  80 6D 89 04 */	lwz r3, lbl_rot_match_pool-_SDA_BASE_(r13)
/* 8001FD80 0001CB80  1C 00 00 44 */	mulli r0, r0, 0x44
/* 8001FD84 0001CB84  7C 03 02 14 */	add r0, r3, r0
/* 8001FD88 0001CB88  90 0D 89 08 */	stw r0, lbl_rot_match_alist-_SDA_BASE_(r13)
...
/* 8001FD9C 0001CB9C  80 6D 89 08 */	lwz r3, lbl_rot_match_alist-_SDA_BASE_(r13)
...
/* 8001FDB4 0001CBB4  90 0D 89 08 */	stw r0, lbl_rot_match_alist-_SDA_BASE_(r13)
