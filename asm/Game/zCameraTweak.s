...
/* 8017EF38 0017BD38  3C 60 80 33 */	lis r3, lbl_zcam_neartweak@ha
/* 8017EF3C 0017BD3C  90 01 00 14 */	stw r0, 0x14(r1)
/* 8017EF40 0017BD40  38 63 B5 68 */	addi r3, r3, lbl_zcam_neartweak@l
/* 8017EF44 0017BD44  C0 2D 80 D0 */	lfs f1, lbl_zcam_near_d-_SDA_BASE_(r13)
/* 8017EF48 0017BD48  C0 4D 80 D4 */	lfs f2, lbl_zcam_near_h-_SDA_BASE_(r13)
/* 8017EF4C 0017BD4C  C0 6D 80 D8 */	lfs f3, lbl_zcam_near_pitch-_SDA_BASE_(r13)
/* 8017EF50 0017BD50  4B FF FF 55 */	bl zCameraTweak.zCameraTweak_LookPreCalc__FP13zCamTweakLookfff
/* 8017EF54 0017BD54  3C 60 80 33 */	lis r3, lbl_zcam_fartweak@ha
/* 8017EF58 0017BD58  C0 2D 80 DC */	lfs f1, lbl_zcam_far_d-_SDA_BASE_(r13)
/* 8017EF5C 0017BD5C  C0 4D 80 E0 */	lfs f2, lbl_zcam_far_h-_SDA_BASE_(r13)
/* 8017EF60 0017BD60  38 63 B5 74 */	addi r3, r3, lbl_zcam_fartweak@l
/* 8017EF64 0017BD64  C0 6D 80 E4 */	lfs f3, lbl_zcam_far_pitch-_SDA_BASE_(r13)
...
/* 8017EFB0 0017BDB0  3C 80 80 33 */	lis r4, lbl_sCamTweakList@ha
/* 8017EFB4 0017BDB4  80 AD 97 B8 */	lwz r5, lbl_sCamTweakCount-_SDA_BASE_(r13)
/* 8017EFB8 0017BDB8  38 84 B4 C8 */	addi r4, r4, lbl_sCamTweakList@l
...
/* 8017F018 0017BE18  3C 60 80 33 */	lis r3, lbl_sCamTweakList@ha
/* 8017F01C 0017BE1C  7C BA 2B 78 */	mr r26, r5
/* 8017F020 0017BE20  3B 83 B4 C8 */	addi r28, r3, lbl_sCamTweakList@l
...
/* 8017F068 0017BE68  3C 60 80 33 */	lis r3, lbl_sCamTweakList@ha
/* 8017F06C 0017BE6C  38 63 B4 C8 */	addi r3, r3, lbl_sCamTweakList@l
...
/* 8017F07C 0017BE7C  C0 02 AE 50 */	lfs f0, lbl__536_1-_SDA2_BASE_(r2)
...
lbl_8017F08C:
/* 8017F08C 0017BE8C  3C 60 80 33 */	lis r3, lbl_sCamTweakList@ha
/* 8017F090 0017BE90  38 03 B4 C8 */	addi r0, r3, lbl_sCamTweakList@l
/* 8017F094 0017BE94  7C 60 2A 14 */	add r3, r0, r5
/* 8017F098 0017BE98  D0 03 00 08 */	stfs f0, 8(r3)
/* 8017F09C 0017BE9C  C0 22 AE 54 */	lfs f1, lbl__537-_SDA2_BASE_(r2)
/* 8017F0A0 0017BEA0  C0 02 AE 58 */	lfs f0, lbl__538-_SDA2_BASE_(r2)
...
/* 8017F0B0 0017BEB0  C0 02 AE 50 */	lfs f0, lbl__536_1-_SDA2_BASE_(r2)
...
lbl_8017F0C0:
/* 8017F0C0 0017BEC0  3C 60 80 33 */	lis r3, lbl_sCamTweakList@ha
/* 8017F0C4 0017BEC4  2C 1F 00 00 */	cmpwi r31, 0
/* 8017F0C8 0017BEC8  38 83 B4 C8 */	addi r4, r3, lbl_sCamTweakList@l
/* 8017F0CC 0017BECC  7C 64 2A 14 */	add r3, r4, r5
/* 8017F0D0 0017BED0  D0 03 00 10 */	stfs f0, 0x10(r3)
/* 8017F0D4 0017BED4  80 6D 97 B8 */	lwz r3, lbl_sCamTweakCount-_SDA_BASE_(r13)
/* 8017F0D8 0017BED8  38 03 00 01 */	addi r0, r3, 1
/* 8017F0DC 0017BEDC  90 0D 97 B8 */	stw r0, lbl_sCamTweakCount-_SDA_BASE_(r13)
/* 8017F0E0 0017BEE0  40 82 00 5C */	bne lbl_8017F13C
/* 8017F0E4 0017BEE4  C0 8D 97 BC */	lfs f4, lbl_sCamTweakLerp-_SDA_BASE_(r13)
/* 8017F0E8 0017BEE8  38 6D 97 C4 */	addi r3, r13, lbl_sCamTweakPitch-_SDA_BASE_
/* 8017F0EC 0017BEEC  C0 42 AE 4C */	lfs f2, lbl__464_1-_SDA2_BASE_(r2)
/* 8017F0F0 0017BEF0  38 AD 97 CC */	addi r5, r13, lbl_sCamTweakDistMult-_SDA_BASE_
/* 8017F0F4 0017BEF4  C0 0D 97 C4 */	lfs f0, lbl_sCamTweakPitch-_SDA_BASE_(r13)
...
/* 8017F110 0017BF10  C0 0D 97 CC */	lfs f0, lbl_sCamTweakDistMult-_SDA_BASE_(r13)
...
/* 8017F120 0017BF20  D0 4D 97 BC */	stfs f2, lbl_sCamTweakLerp-_SDA_BASE_(r13)
/* 8017F124 0017BF24  C0 04 00 08 */	lfs f0, 8(r4)
/* 8017F128 0017BF28  D0 0D 97 C0 */	stfs f0, lbl_sCamTweakTime-_SDA_BASE_(r13)
/* 8017F12C 0017BF2C  C0 04 00 0C */	lfs f0, 0xc(r4)
/* 8017F130 0017BF30  D0 0D 97 C4 */	stfs f0, lbl_sCamTweakPitch-_SDA_BASE_(r13)
/* 8017F134 0017BF34  C0 04 00 10 */	lfs f0, 0x10(r4)
/* 8017F138 0017BF38  D0 0D 97 CC */	stfs f0, lbl_sCamTweakDistMult-_SDA_BASE_(r13)
lbl_8017F13C:
...
/* 8017F1A4 0017BFA4  3C 80 80 33 */	lis r4, lbl_sCamTweakList@ha
/* 8017F1A8 0017BFA8  38 E0 00 00 */	li r7, 0
/* 8017F1AC 0017BFAC  90 01 00 24 */	stw r0, 0x24(r1)
/* 8017F1B0 0017BFB0  38 84 B4 C8 */	addi r4, r4, lbl_sCamTweakList@l
...
/* 8017F1C0 0017BFC0  80 CD 97 B8 */	lwz r6, lbl_sCamTweakCount-_SDA_BASE_(r13)
...
/* 8017F1E4 0017BFE4  C0 8D 97 BC */	lfs f4, lbl_sCamTweakLerp-_SDA_BASE_(r13)
/* 8017F1E8 0017BFE8  38 8D 97 C4 */	addi r4, r13, lbl_sCamTweakPitch-_SDA_BASE_
/* 8017F1EC 0017BFEC  C0 42 AE 4C */	lfs f2, lbl__464_1-_SDA2_BASE_(r2)
/* 8017F1F0 0017BFF0  38 AD 97 CC */	addi r5, r13, lbl_sCamTweakDistMult-_SDA_BASE_
/* 8017F1F4 0017BFF4  3C 60 80 33 */	lis r3, lbl_sCamTweakList@ha
/* 8017F1F8 0017BFF8  C0 0D 97 C4 */	lfs f0, lbl_sCamTweakPitch-_SDA_BASE_(r13)
...
/* 8017F208 0017C008  38 63 B4 C8 */	addi r3, r3, lbl_sCamTweakList@l
...
/* 8017F21C 0017C01C  C0 0D 97 CC */	lfs f0, lbl_sCamTweakDistMult-_SDA_BASE_(r13)
...
/* 8017F22C 0017C02C  D0 4D 97 BC */	stfs f2, lbl_sCamTweakLerp-_SDA_BASE_(r13)
/* 8017F230 0017C030  C0 03 00 08 */	lfs f0, 8(r3)
/* 8017F234 0017C034  D0 0D 97 C0 */	stfs f0, lbl_sCamTweakTime-_SDA_BASE_(r13)
/* 8017F238 0017C038  40 81 00 18 */	ble lbl_8017F250
/* 8017F23C 0017C03C  C0 03 00 20 */	lfs f0, 0x20(r3)
/* 8017F240 0017C040  D0 0D 97 C4 */	stfs f0, lbl_sCamTweakPitch-_SDA_BASE_(r13)
/* 8017F244 0017C044  C0 03 00 24 */	lfs f0, 0x24(r3)
/* 8017F248 0017C048  D0 0D 97 CC */	stfs f0, lbl_sCamTweakDistMult-_SDA_BASE_(r13)
/* 8017F24C 0017C04C  48 00 00 14 */	b lbl_8017F260
lbl_8017F250:
/* 8017F250 0017C050  C0 02 AE 48 */	lfs f0, lbl__463_1-_SDA2_BASE_(r2)
/* 8017F254 0017C054  D0 0D 97 C4 */	stfs f0, lbl_sCamTweakPitch-_SDA_BASE_(r13)
/* 8017F258 0017C058  C0 02 AE 4C */	lfs f0, lbl__464_1-_SDA2_BASE_(r2)
/* 8017F25C 0017C05C  D0 0D 97 CC */	stfs f0, lbl_sCamTweakDistMult-_SDA_BASE_(r13)
lbl_8017F260:
/* 8017F260 0017C060  1C 07 00 14 */	mulli r0, r7, 0x14
/* 8017F264 0017C064  3C 60 80 33 */	lis r3, lbl_sCamTweakList@ha
/* 8017F268 0017C068  7C FD 3B 78 */	mr r29, r7
/* 8017F26C 0017C06C  3B E3 B4 C8 */	addi r31, r3, lbl_sCamTweakList@l
...
lbl_8017F294:
/* 8017F294 0017C094  80 6D 97 B8 */	lwz r3, lbl_sCamTweakCount-_SDA_BASE_(r13)
...
/* 8017F2A4 0017C0A4  90 0D 97 B8 */	stw r0, lbl_sCamTweakCount-_SDA_BASE_(r13)
...
/* 8017F2D8 0017C0D8  38 8D 97 C4 */	addi r4, r13, lbl_sCamTweakPitch-_SDA_BASE_
/* 8017F2DC 0017C0DC  90 0D 97 B8 */	stw r0, lbl_sCamTweakCount-_SDA_BASE_(r13)
/* 8017F2E0 0017C0E0  38 6D 97 CC */	addi r3, r13, lbl_sCamTweakDistMult-_SDA_BASE_
/* 8017F2E4 0017C0E4  C0 02 AE 48 */	lfs f0, lbl__463_1-_SDA2_BASE_(r2)
/* 8017F2E8 0017C0E8  D0 0D 97 C4 */	stfs f0, lbl_sCamTweakPitch-_SDA_BASE_(r13)
/* 8017F2EC 0017C0EC  C0 02 AE 48 */	lfs f0, lbl__463_1-_SDA2_BASE_(r2)
/* 8017F2F0 0017C0F0  D0 04 00 04 */	stfs f0, 4(r4)
/* 8017F2F4 0017C0F4  C0 02 AE 4C */	lfs f0, lbl__464_1-_SDA2_BASE_(r2)
/* 8017F2F8 0017C0F8  D0 0D 97 CC */	stfs f0, lbl_sCamTweakDistMult-_SDA_BASE_(r13)
/* 8017F2FC 0017C0FC  C0 02 AE 4C */	lfs f0, lbl__464_1-_SDA2_BASE_(r2)
/* 8017F300 0017C100  D0 03 00 04 */	stfs f0, 4(r3)
/* 8017F304 0017C104  C0 02 AE 5C */	lfs f0, lbl__574-_SDA2_BASE_(r2)
/* 8017F308 0017C108  D0 0D 97 C0 */	stfs f0, lbl_sCamTweakTime-_SDA_BASE_(r13)
/* 8017F30C 0017C10C  C0 02 AE 48 */	lfs f0, lbl__463_1-_SDA2_BASE_(r2)
/* 8017F310 0017C110  D0 0D 97 BC */	stfs f0, lbl_sCamTweakLerp-_SDA_BASE_(r13)
/* 8017F314 0017C114  C0 02 AE 48 */	lfs f0, lbl__463_1-_SDA2_BASE_(r2)
/* 8017F318 0017C118  D0 0D 97 D4 */	stfs f0, lbl_sCamTweakPitchCur-_SDA_BASE_(r13)
/* 8017F31C 0017C11C  C0 02 AE 4C */	lfs f0, lbl__464_1-_SDA2_BASE_(r2)
/* 8017F320 0017C120  D0 0D 97 D8 */	stfs f0, lbl_sCamTweakDistMultCur-_SDA_BASE_(r13)
...
/* 8017F338 0017C138  C0 0D 97 C0 */	lfs f0, lbl_sCamTweakTime-_SDA_BASE_(r13)
/* 8017F33C 0017C13C  C0 4D 97 BC */	lfs f2, lbl_sCamTweakLerp-_SDA_BASE_(r13)
/* 8017F340 0017C140  EC 01 00 24 */	fdivs f0, f1, f0
/* 8017F344 0017C144  EC 02 00 28 */	fsubs f0, f2, f0
/* 8017F348 0017C148  D0 0D 97 BC */	stfs f0, lbl_sCamTweakLerp-_SDA_BASE_(r13)
/* 8017F34C 0017C14C  C0 2D 97 BC */	lfs f1, lbl_sCamTweakLerp-_SDA_BASE_(r13)
/* 8017F350 0017C150  C0 02 AE 48 */	lfs f0, lbl__463_1-_SDA2_BASE_(r2)
/* 8017F354 0017C154  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 8017F358 0017C158  40 80 00 08 */	bge lbl_8017F360
/* 8017F35C 0017C15C  D0 0D 97 BC */	stfs f0, lbl_sCamTweakLerp-_SDA_BASE_(r13)
lbl_8017F360:
/* 8017F360 0017C160  C0 6D 97 BC */	lfs f3, lbl_sCamTweakLerp-_SDA_BASE_(r13)
/* 8017F364 0017C164  38 8D 97 C4 */	addi r4, r13, lbl_sCamTweakPitch-_SDA_BASE_
/* 8017F368 0017C168  C0 02 AE 4C */	lfs f0, lbl__464_1-_SDA2_BASE_(r2)
/* 8017F36C 0017C16C  3C 60 80 33 */	lis r3, lbl_zcam_fartweak@ha
/* 8017F370 0017C170  3B E3 B5 74 */	addi r31, r3, lbl_zcam_fartweak@l
/* 8017F374 0017C174  C0 2D 97 C4 */	lfs f1, lbl_sCamTweakPitch-_SDA_BASE_(r13)
/* 8017F378 0017C178  EC 80 18 28 */	fsubs f4, f0, f3
/* 8017F37C 0017C17C  C0 44 00 04 */	lfs f2, 4(r4)
/* 8017F380 0017C180  38 6D 97 CC */	addi r3, r13, lbl_sCamTweakDistMult-_SDA_BASE_
/* 8017F384 0017C184  EC 01 01 32 */	fmuls f0, f1, f4
/* 8017F388 0017C188  EC 02 00 FA */	fmadds f0, f2, f3, f0
/* 8017F38C 0017C18C  D0 0D 97 D4 */	stfs f0, lbl_sCamTweakPitchCur-_SDA_BASE_(r13)
/* 8017F390 0017C190  C0 0D 97 CC */	lfs f0, lbl_sCamTweakDistMult-_SDA_BASE_(r13)
...
/* 8017F3A0 0017C1A0  D0 0D 97 D8 */	stfs f0, lbl_sCamTweakDistMultCur-_SDA_BASE_(r13)
/* 8017F3A4 0017C1A4  80 0D 8B 7C */	lwz r0, lbl_zcam_near-_SDA_BASE_(r13)
/* 8017F3A8 0017C1A8  2C 00 00 00 */	cmpwi r0, 0
/* 8017F3AC 0017C1AC  41 82 00 0C */	beq lbl_8017F3B8
/* 8017F3B0 0017C1B0  3C 60 80 33 */	lis r3, lbl_zcam_neartweak@ha
/* 8017F3B4 0017C1B4  3B E3 B5 68 */	addi r31, r3, lbl_zcam_neartweak@l
lbl_8017F3B8:
/* 8017F3B8 0017C1B8  C0 3F 00 08 */	lfs f1, 8(r31)
/* 8017F3BC 0017C1BC  C0 0D 97 D4 */	lfs f0, lbl_sCamTweakPitchCur-_SDA_BASE_(r13)
/* 8017F3C0 0017C1C0  EC 21 00 2A */	fadds f1, f1, f0
/* 8017F3C4 0017C1C4  4B F4 5A CD */	bl icos__Ff
/* 8017F3C8 0017C1C8  C0 4D 97 D8 */	lfs f2, lbl_sCamTweakDistMultCur-_SDA_BASE_(r13)
...
/* 8017F3D8 0017C1D8  D0 0D 97 DC */	stfs f0, lbl_sCamD-_SDA_BASE_(r13)
/* 8017F3DC 0017C1DC  C0 3F 00 08 */	lfs f1, 8(r31)
/* 8017F3E0 0017C1E0  C0 0D 97 D4 */	lfs f0, lbl_sCamTweakPitchCur-_SDA_BASE_(r13)
/* 8017F3E4 0017C1E4  EC 21 00 2A */	fadds f1, f1, f0
/* 8017F3E8 0017C1E8  4B F4 5A 65 */	bl isin__Ff
/* 8017F3EC 0017C1EC  C0 6D 97 D8 */	lfs f3, lbl_sCamTweakDistMultCur-_SDA_BASE_(r13)
...
/* 8017F400 0017C200  D0 0D 97 E0 */	stfs f0, lbl_sCamH-_SDA_BASE_(r13)
/* 8017F404 0017C204  C0 3F 00 08 */	lfs f1, 8(r31)
/* 8017F408 0017C208  C0 0D 97 D4 */	lfs f0, lbl_sCamTweakPitchCur-_SDA_BASE_(r13)
/* 8017F40C 0017C20C  EC 01 00 2A */	fadds f0, f1, f0
/* 8017F410 0017C210  D0 0D 97 E4 */	stfs f0, lbl_sCamPitch-_SDA_BASE_(r13)
...
/* 8017F584 0017C384  C8 22 AE 60 */	lfd f1, lbl__640_2-_SDA2_BASE_(r2)
