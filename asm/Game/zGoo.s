...
/* 8012375C 0012055C  80 6D 89 E0 */	lwz r3, lbl_gActiveHeap-_SDA_BASE_(r13)
/* 80123760 00120560  4B F1 01 E1 */	bl xMemAlloc__FUiUii
/* 80123764 00120564  90 6D 95 50 */	stw r3, lbl_zgoo_gps-_SDA_BASE_(r13)
/* 80123768 00120568  93 ED 95 54 */	stw r31, lbl_zgoo_ngps-_SDA_BASE_(r13)
...
/* 80123784 00120584  90 0D 95 50 */	stw r0, lbl_zgoo_gps-_SDA_BASE_(r13)
/* 80123788 00120588  90 0D 95 54 */	stw r0, lbl_zgoo_ngps-_SDA_BASE_(r13)
/* 8012378C 0012058C  90 0D 95 58 */	stw r0, lbl_zgoo_nused-_SDA_BASE_(r13)
...
/* 801237A0 001205A0  80 ED 95 50 */	lwz r7, lbl_zgoo_gps-_SDA_BASE_(r13)
/* 801237A4 001205A4  80 CD 95 58 */	lwz r6, lbl_zgoo_nused-_SDA_BASE_(r13)
...
lbl_801237D4:
/* 801237D4 001205D4  80 0D 95 54 */	lwz r0, lbl_zgoo_ngps-_SDA_BASE_(r13)
...
/* 801237FC 001205FC  80 AD 95 58 */	lwz r5, lbl_zgoo_nused-_SDA_BASE_(r13)
/* 80123800 00120600  38 05 00 01 */	addi r0, r5, 1
/* 80123804 00120604  90 0D 95 58 */	stw r0, lbl_zgoo_nused-_SDA_BASE_(r13)
...
/* 80123850 00120650  80 CD 95 50 */	lwz r6, lbl_zgoo_gps-_SDA_BASE_(r13)
/* 80123854 00120654  80 0D 95 58 */	lwz r0, lbl_zgoo_nused-_SDA_BASE_(r13)
...
/* 801238A8 001206A8  80 0D 95 50 */	lwz r0, lbl_zgoo_gps-_SDA_BASE_(r13)
...
/* 801238C8 001206C8  80 8D 95 50 */	lwz r4, lbl_zgoo_gps-_SDA_BASE_(r13)
...
lbl_80123910:
/* 80123910 00120710  80 6D 95 50 */	lwz r3, lbl_zgoo_gps-_SDA_BASE_(r13)
...
/* 80123938 00120738  C0 22 A0 C8 */	lfs f1, lbl__742_3-_SDA2_BASE_(r2)
...
/* 8012394C 0012074C  80 CD 95 50 */	lwz r6, lbl_zgoo_gps-_SDA_BASE_(r13)
...
lbl_80123970:
/* 80123970 00120770  80 0D 95 58 */	lwz r0, lbl_zgoo_nused-_SDA_BASE_(r13)
...
lbl_801239B8:
/* 801239B8 001207B8  80 0D 95 50 */	lwz r0, lbl_zgoo_gps-_SDA_BASE_(r13)
...
/* 801239D0 001207D0  C0 22 A0 C8 */	lfs f1, lbl__742_3-_SDA2_BASE_(r2)
...
lbl_801239FC:
/* 801239FC 001207FC  80 0D 95 58 */	lwz r0, lbl_zgoo_nused-_SDA_BASE_(r13)
...
lbl_80123A40:
/* 80123A40 00120840  C0 22 A0 C8 */	lfs f1, lbl__742_3-_SDA2_BASE_(r2)
/* 80123A44 00120844  38 1F 00 08 */	addi r0, r31, 8
/* 80123A48 00120848  80 6D 95 50 */	lwz r3, lbl_zgoo_gps-_SDA_BASE_(r13)
...
lbl_80123A6C:
/* 80123A6C 0012086C  80 0D 95 58 */	lwz r0, lbl_zgoo_nused-_SDA_BASE_(r13)
...
lbl_80123AB8:
/* 80123AB8 001208B8  80 6D 95 50 */	lwz r3, lbl_zgoo_gps-_SDA_BASE_(r13)
...
/* 80123AD4 001208D4  C0 42 A0 C8 */	lfs f2, lbl__742_3-_SDA2_BASE_(r2)
/* 80123AD8 001208D8  38 80 02 1A */	li r4, 0x21a
/* 80123ADC 001208DC  C0 22 A0 CC */	lfs f1, lbl__780_2-_SDA2_BASE_(r2)
...
lbl_80123AF4:
/* 80123AF4 001208F4  80 0D 95 58 */	lwz r0, lbl_zgoo_nused-_SDA_BASE_(r13)
