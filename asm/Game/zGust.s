...
lbl_8009ADAC:
/* 8009ADAC 00097BAC  C0 02 91 10 */	lfs f0, lbl__646-_SDA2_BASE_(r2)
...
/* 8009AE34 00097C34  B0 6D 8F B4 */	sth r3, lbl_ngusts-_SDA_BASE_(r13)
/* 8009AE38 00097C38  A0 0D 8F B4 */	lhz r0, lbl_ngusts-_SDA_BASE_(r13)
...
/* 8009AE48 00097C48  80 6D 89 E0 */	lwz r3, lbl_gActiveHeap-_SDA_BASE_(r13)
/* 8009AE4C 00097C4C  38 A0 00 00 */	li r5, 0
/* 8009AE50 00097C50  4B F9 8A F1 */	bl xMemAlloc__FUiUii
/* 8009AE54 00097C54  90 6D 8F B0 */	stw r3, lbl_gusts-_SDA_BASE_(r13)
...
/* 8009AE78 00097C78  80 AD 8F B0 */	lwz r5, lbl_gusts-_SDA_BASE_(r13)
...
lbl_8009AE90:
/* 8009AE90 00097C90  A0 0D 8F B4 */	lhz r0, lbl_ngusts-_SDA_BASE_(r13)
...
/* 8009AEA8 00097CA8  90 0D 8F B0 */	stw r0, lbl_gusts-_SDA_BASE_(r13)
lbl_8009AEAC:
...
/* 8009AED4 00097CD4  80 0D 8F B0 */	lwz r0, lbl_gusts-_SDA_BASE_(r13)
...
/* 8009AEEC 00097CEC  80 6D 8F B0 */	lwz r3, lbl_gusts-_SDA_BASE_(r13)
...
lbl_8009AF00:
/* 8009AF00 00097D00  A0 0D 8F B4 */	lhz r0, lbl_ngusts-_SDA_BASE_(r13)
...
/* 8009AF10 00097D10  3C 60 80 26 */	lis r3, lbl__stringBase0_40@ha
/* 8009AF14 00097D14  38 63 CB 50 */	addi r3, r3, lbl__stringBase0_40@l
/* 8009AF18 00097D18  4B FB 12 FD */	bl xStrHash__FPCc
/* 8009AF1C 00097D1C  48 00 D8 D1 */	bl zParEmitterFind__FUi
/* 8009AF20 00097D20  3C 80 80 26 */	lis r4, lbl__stringBase0_40@ha
/* 8009AF24 00097D24  90 6D 8F B8 */	stw r3, lbl_sGustDustEmitter-_SDA_BASE_(r13)
/* 8009AF28 00097D28  38 64 CB 50 */	addi r3, r4, lbl__stringBase0_40@l
...
/* 8009AF38 00097D38  90 6D 8F BC */	stw r3, lbl_sGustDebrisEmitter-_SDA_BASE_(r13)
lbl_8009AF3C:
...
/* 8009AF5C 00097D5C  C0 02 91 10 */	lfs f0, lbl__646-_SDA2_BASE_(r2)
...
/* 8009AF84 00097D84  C0 02 91 10 */	lfs f0, lbl__646-_SDA2_BASE_(r2)
/* 8009AF88 00097D88  D0 03 00 20 */	stfs f0, 0x20(r3)
/* 8009AF8C 00097D8C  4E 80 00 20 */	blr 

.global zGustGetGust__FUs
zGustGetGust__FUs:
/* 8009AF90 00097D90  80 8D 8F B0 */	lwz r4, lbl_gusts-_SDA_BASE_(r13)
...
/* 8009AFCC 00097DCC  80 0D 8F B0 */	lwz r0, lbl_gusts-_SDA_BASE_(r13)
...
lbl_8009AFF4:
/* 8009AFF4 00097DF4  80 0D 8F B0 */	lwz r0, lbl_gusts-_SDA_BASE_(r13)
...
/* 8009B034 00097E34  C0 02 91 14 */	lfs f0, lbl__785_2-_SDA2_BASE_(r2)
/* 8009B038 00097E38  80 0D 8F B0 */	lwz r0, lbl_gusts-_SDA_BASE_(r13)
...
/* 8009B060 00097E60  C0 02 91 14 */	lfs f0, lbl__785_2-_SDA2_BASE_(r2)
...
/* 8009B084 00097E84  C0 02 91 14 */	lfs f0, lbl__785_2-_SDA2_BASE_(r2)
...
/* 8009B0A8 00097EA8  C0 02 91 14 */	lfs f0, lbl__785_2-_SDA2_BASE_(r2)
...
/* 8009B0DC 00097EDC  C0 02 91 18 */	lfs f0, lbl__786_3-_SDA2_BASE_(r2)
/* 8009B0E0 00097EE0  D0 04 00 14 */	stfs f0, 0x14(r4)
/* 8009B0E4 00097EE4  48 00 00 58 */	b lbl_8009B13C
lbl_8009B0E8:
/* 8009B0E8 00097EE8  80 6D 8F B0 */	lwz r3, lbl_gusts-_SDA_BASE_(r13)
...
/* 8009B10C 00097F0C  C0 22 91 1C */	lfs f1, lbl__787_2-_SDA2_BASE_(r2)
...
/* 8009B120 00097F20  C0 02 91 20 */	lfs f0, lbl__788_1-_SDA2_BASE_(r2)
...
lbl_8009B144:
/* 8009B144 00097F44  A0 0D 8F B4 */	lhz r0, lbl_ngusts-_SDA_BASE_(r13)
...
/* 8009B18C 00097F8C  C0 02 91 24 */	lfs f0, lbl__789_1-_SDA2_BASE_(r2)
/* 8009B190 00097F90  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 8009B194 00097F94  41 80 00 68 */	blt lbl_8009B1FC
/* 8009B198 00097F98  C0 02 91 1C */	lfs f0, lbl__787_2-_SDA2_BASE_(r2)
...
/* 8009B1AC 00097FAC  C0 02 91 24 */	lfs f0, lbl__789_1-_SDA2_BASE_(r2)
...
/* 8009B1C8 00097FC8  C0 02 91 1C */	lfs f0, lbl__787_2-_SDA2_BASE_(r2)
...
/* 8009B1EC 00097FEC  C0 02 91 24 */	lfs f0, lbl__789_1-_SDA2_BASE_(r2)
...
/* 8009B204 00098004  C0 02 91 24 */	lfs f0, lbl__789_1-_SDA2_BASE_(r2)
...
/* 8009B3A8 000981A8  C0 02 91 24 */	lfs f0, lbl__789_1-_SDA2_BASE_(r2)
...
/* 8009B3D0 000981D0  C0 02 91 24 */	lfs f0, lbl__789_1-_SDA2_BASE_(r2)
...
/* 8009B430 00098230  C0 02 91 28 */	lfs f0, lbl__860_2-_SDA2_BASE_(r2)
...
/* 8009B460 00098260  C0 02 91 10 */	lfs f0, lbl__646-_SDA2_BASE_(r2)
...
/* 8009B47C 0009827C  83 8D 8F B8 */	lwz r28, lbl_sGustDustEmitter-_SDA_BASE_(r13)
/* 8009B480 00098280  48 00 00 08 */	b lbl_8009B488
lbl_8009B484:
/* 8009B484 00098284  83 8D 8F BC */	lwz r28, lbl_sGustDebrisEmitter-_SDA_BASE_(r13)
lbl_8009B488:
...
/* 8009B500 00098300  C0 02 91 24 */	lfs f0, lbl__789_1-_SDA2_BASE_(r2)
/* 8009B504 00098304  D0 01 01 54 */	stfs f0, 0x154(r1)
/* 8009B508 00098308  C0 42 91 2C */	lfs f2, lbl__861_2-_SDA2_BASE_(r2)
...
/* 8009B528 00098328  C0 02 91 14 */	lfs f0, lbl__785_2-_SDA2_BASE_(r2)
...
/* 8009B58C 0009838C  C0 22 91 30 */	lfs f1, lbl__862_2-_SDA2_BASE_(r2)
...
/* 8009B5B4 000983B4  C0 22 91 34 */	lfs f1, lbl__863_1-_SDA2_BASE_(r2)
...
/* 8009B5E0 000983E0  C0 22 91 38 */	lfs f1, lbl__864_2-_SDA2_BASE_(r2)
...
lbl_8009B638:
/* 8009B638 00098438  80 0D 8F B0 */	lwz r0, lbl_gusts-_SDA_BASE_(r13)
...
lbl_8009B65C:
/* 8009B65C 0009845C  A0 0D 8F B4 */	lhz r0, lbl_ngusts-_SDA_BASE_(r13)
