...
/* 8009E034 0009AE34  3C 80 80 2F */	lis r4, lbl_sLight@ha
...
/* 8009E048 0009AE48  38 64 8F 88 */	addi r3, r4, lbl_sLight@l
/* 8009E04C 0009AE4C  38 80 00 00 */	li r4, 0
/* 8009E050 0009AE50  4B F6 54 09 */	bl memset
/* 8009E054 0009AE54  38 00 00 00 */	li r0, 0
/* 8009E058 0009AE58  90 0D 8F E8 */	stw r0, lbl_sLightTotal-_SDA_BASE_(r13)
/* 8009E05C 0009AE5C  80 8D 8F EC */	lwz r4, lbl_sPartitionVolume-_SDA_BASE_(r13)
/* 8009E060 0009AE60  28 04 00 00 */	cmplwi r4, 0
/* 8009E064 0009AE64  41 82 00 20 */	beq lbl_8009E084
/* 8009E068 0009AE68  3C 60 80 2F */	lis r3, lbl_sLightPart@ha
/* 8009E06C 0009AE6C  38 A0 00 0A */	li r5, 0xa
/* 8009E070 0009AE70  38 63 90 08 */	addi r3, r3, lbl_sLightPart@l
...
lbl_8009E084:
/* 8009E084 0009AE84  3C 60 80 2F */	lis r3, lbl_sLightPart@ha
/* 8009E088 0009AE88  7F E4 FB 78 */	mr r4, r31
/* 8009E08C 0009AE8C  38 63 90 08 */	addi r3, r3, lbl_sLightPart@l
...
lbl_8009E0A0:
/* 8009E0A0 0009AEA0  3C 60 80 2F */	lis r3, lbl_sLightPart@ha
/* 8009E0A4 0009AEA4  3C 80 80 26 */	lis r4, lbl__stringBase0_43@ha
/* 8009E0A8 0009AEA8  38 63 90 08 */	addi r3, r3, lbl_sLightPart@l
/* 8009E0AC 0009AEAC  38 84 CD 30 */	addi r4, r4, lbl__stringBase0_43@l
...
/* 8009E198 0009AF98  80 CD 8F E8 */	lwz r6, lbl_sLightTotal-_SDA_BASE_(r13)
/* 8009E19C 0009AF9C  3C 60 80 2F */	lis r3, lbl_sLight@ha
/* 8009E1A0 0009AFA0  38 A3 8F 88 */	addi r5, r3, lbl_sLight@l
...
/* 8009E1B0 0009AFB0  90 8D 8F E8 */	stw r4, lbl_sLightTotal-_SDA_BASE_(r13)
...
/* 8009E248 0009B048  80 6D 89 E0 */	lwz r3, lbl_gActiveHeap-_SDA_BASE_(r13)
...
lbl_8009E278:
/* 8009E278 0009B078  3C 60 80 2F */	lis r3, lbl_sLightPart@ha
/* 8009E27C 0009B07C  7F E4 FB 78 */	mr r4, r31
/* 8009E280 0009B080  38 63 90 08 */	addi r3, r3, lbl_sLightPart@l
...
/* 8009E2B0 0009B0B0  3C 60 80 2F */	lis r3, lbl_sLight@ha
...
/* 8009E2C4 0009B0C4  3B C3 8F 88 */	addi r30, r3, lbl_sLight@l
...
lbl_8009E304:
/* 8009E304 0009B104  80 0D 8F E8 */	lwz r0, lbl_sLightTotal-_SDA_BASE_(r13)
...
/* 8009E338 0009B138  3C 60 80 2F */	lis r3, lbl_sLight@ha
/* 8009E33C 0009B13C  90 01 00 24 */	stw r0, 0x24(r1)
/* 8009E340 0009B140  93 E1 00 1C */	stw r31, 0x1c(r1)
/* 8009E344 0009B144  3B E3 8F 88 */	addi r31, r3, lbl_sLight@l
...
/* 8009E354 0009B154  83 CD 8F E8 */	lwz r30, lbl_sLightTotal-_SDA_BASE_(r13)
...
/* 8009E364 0009B164  80 6D 8F E8 */	lwz r3, lbl_sLightTotal-_SDA_BASE_(r13)
...
/* 8009E374 0009B174  90 0D 8F E8 */	stw r0, lbl_sLightTotal-_SDA_BASE_(r13)
lbl_8009E378:
...
/* 8009E384 0009B184  90 0D 8F E8 */	stw r0, lbl_sLightTotal-_SDA_BASE_(r13)
...
/* 8009E538 0009B338  C0 02 91 D8 */	lfs f0, lbl__752-_SDA2_BASE_(r2)
...
/* 8009E554 0009B354  3C 60 80 2F */	lis r3, lbl_sLightPart@ha
/* 8009E558 0009B358  80 BF 00 58 */	lwz r5, 0x58(r31)
/* 8009E55C 0009B35C  38 63 90 08 */	addi r3, r3, lbl_sLightPart@l
...
/* 8009E574 0009B374  3C 60 80 29 */	lis r3, lbl_sEffectFuncs@ha
/* 8009E578 0009B378  38 63 FA C0 */	addi r3, r3, lbl_sEffectFuncs@l
...
/* 8009E5C0 0009B3C0  3C 60 80 2F */	lis r3, lbl_sLight@ha
/* 8009E5C4 0009B3C4  90 01 00 24 */	stw r0, 0x24(r1)
/* 8009E5C8 0009B3C8  93 E1 00 1C */	stw r31, 0x1c(r1)
/* 8009E5CC 0009B3CC  3B E3 8F 88 */	addi r31, r3, lbl_sLight@l
...
/* 8009E614 0009B414  80 AD 92 08 */	lwz r5, lbl_gLightWorld-_SDA_BASE_(r13)
/* 8009E618 0009B418  3C 60 80 2F */	lis r3, lbl_gTemporaryLights@ha
/* 8009E61C 0009B41C  80 9C 00 04 */	lwz r4, 4(r28)
/* 8009E620 0009B420  38 63 90 48 */	addi r3, r3, lbl_gTemporaryLights@l
/* 8009E624 0009B424  80 05 00 40 */	lwz r0, 0x40(r5)
/* 8009E628 0009B428  90 04 00 38 */	stw r0, 0x38(r4)
/* 8009E62C 0009B42C  80 AD 92 08 */	lwz r5, lbl_gLightWorld-_SDA_BASE_(r13)
...
/* 8009E63C 0009B43C  80 8D 92 08 */	lwz r4, lbl_gLightWorld-_SDA_BASE_(r13)
...
/* 8009E654 0009B454  80 8D 92 08 */	lwz r4, lbl_gLightWorld-_SDA_BASE_(r13)
/* 8009E658 0009B458  38 05 00 34 */	addi r0, r5, 0x34
/* 8009E65C 0009B45C  90 04 00 40 */	stw r0, 0x40(r4)
/* 8009E660 0009B460  80 0D 8F F0 */	lwz r0, lbl_gNumTemporaryLights-_SDA_BASE_(r13)
/* 8009E664 0009B464  54 00 10 3A */	slwi r0, r0, 2
/* 8009E668 0009B468  7F A3 01 2E */	stwx r29, r3, r0
/* 8009E66C 0009B46C  80 6D 8F F0 */	lwz r3, lbl_gNumTemporaryLights-_SDA_BASE_(r13)
/* 8009E670 0009B470  38 03 00 01 */	addi r0, r3, 1
/* 8009E674 0009B474  90 0D 8F F0 */	stw r0, lbl_gNumTemporaryLights-_SDA_BASE_(r13)
lbl_8009E678:
/* 8009E678 0009B478  3B FF 00 04 */	addi r31, r31, 4
/* 8009E67C 0009B47C  3B DE 00 01 */	addi r30, r30, 1
lbl_8009E680:
/* 8009E680 0009B480  80 0D 8F E8 */	lwz r0, lbl_sLightTotal-_SDA_BASE_(r13)
...
/* 8009E6E0 0009B4E0  C0 02 91 D8 */	lfs f0, lbl__752-_SDA2_BASE_(r2)
...
/* 8009E6F8 0009B4F8  80 6D 89 E0 */	lwz r3, lbl_gActiveHeap-_SDA_BASE_(r13)
...
/* 8009E728 0009B528  3C 60 80 29 */	lis r3, lbl_sDefaultShadowVec@ha
/* 8009E72C 0009B52C  38 83 FB 50 */	addi r4, r3, lbl_sDefaultShadowVec@l
...
/* 8009E73C 0009B53C  C0 22 91 D8 */	lfs f1, lbl__752-_SDA2_BASE_(r2)
...
lbl_8009E764:
/* 8009E764 0009B564  80 6D 92 08 */	lwz r3, lbl_gLightWorld-_SDA_BASE_(r13)
...
lbl_8009E788:
/* 8009E788 0009B588  80 0D 8F F0 */	lwz r0, lbl_gNumTemporaryLights-_SDA_BASE_(r13)
...
/* 8009E798 0009B598  90 0D 8F F0 */	stw r0, lbl_gNumTemporaryLights-_SDA_BASE_(r13)
...
/* 8009E7BC 0009B5BC  90 0D 8F EC */	stw r0, lbl_sPartitionVolume-_SDA_BASE_(r13)
/* 8009E7C0 0009B5C0  48 00 00 24 */	b lbl_8009E7E4
lbl_8009E7C4:
/* 8009E7C4 0009B5C4  3C 60 80 26 */	lis r3, lbl__stringBase0_43@ha
/* 8009E7C8 0009B5C8  38 63 CD 30 */	addi r3, r3, lbl__stringBase0_43@l
...
/* 8009E7E0 0009B5E0  93 ED 8F EC */	stw r31, lbl_sPartitionVolume-_SDA_BASE_(r13)
lbl_8009E7E4:
