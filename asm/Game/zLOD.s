...
/* 800A1D3C 0009EB3C  80 AD 90 14 */	lwz r5, lbl_sManagerCount-_SDA_BASE_(r13)
/* 800A1D40 0009EB40  3C 80 80 2F */	lis r4, lbl_sManagerList@ha
/* 800A1D44 0009EB44  38 84 A9 90 */	addi r4, r4, lbl_sManagerList@l
...
lbl_800A1D6C:
/* 800A1D6C 0009EB6C  80 0D 90 08 */	lwz r0, lbl_sTableCount-_SDA_BASE_(r13)
/* 800A1D70 0009EB70  38 C0 00 00 */	li r6, 0
/* 800A1D74 0009EB74  80 8D 90 0C */	lwz r4, lbl_sTableList-_SDA_BASE_(r13)
...
/* 800A1DD0 0009EBD0  C0 02 92 C4 */	lfs f0, lbl__705_1-_SDA2_BASE_(r2)
...
/* 800A1DFC 0009EBFC  C3 E2 92 C0 */	lfs f31, lbl__704_1-_SDA2_BASE_(r2)
lbl_800A1E00:
/* 800A1E00 0009EC00  54 DE 28 34 */	slwi r30, r6, 5
/* 800A1E04 0009EC04  48 00 00 30 */	b lbl_800A1E34
lbl_800A1E08:
/* 800A1E08 0009EC08  80 6D 90 0C */	lwz r3, lbl_sTableList-_SDA_BASE_(r13)
...
/* 800A1E24 0009EC24  C0 02 92 C8 */	lfs f0, lbl__706-_SDA2_BASE_(r2)
...
/* 800A1E3C 0009EC3C  80 0D 90 14 */	lwz r0, lbl_sManagerCount-_SDA_BASE_(r13)
/* 800A1E40 0009EC40  3C 60 80 2F */	lis r3, lbl_sManagerList@ha
/* 800A1E44 0009EC44  38 63 A9 90 */	addi r3, r3, lbl_sManagerList@l
...
/* 800A1E54 0009EC54  80 0D 90 0C */	lwz r0, lbl_sTableList-_SDA_BASE_(r13)
...
/* 800A1E6C 0009EC6C  C0 02 92 CC */	lfs f0, lbl__707_1-_SDA2_BASE_(r2)
/* 800A1E70 0009EC70  80 0D 90 0C */	lwz r0, lbl_sTableList-_SDA_BASE_(r13)
...
/* 800A1E84 0009EC84  C0 02 92 CC */	lfs f0, lbl__707_1-_SDA2_BASE_(r2)
/* 800A1E88 0009EC88  3C 60 80 2F */	lis r3, lbl_sManagerList@ha
/* 800A1E8C 0009EC8C  80 0D 90 14 */	lwz r0, lbl_sManagerCount-_SDA_BASE_(r13)
/* 800A1E90 0009EC90  38 63 A9 90 */	addi r3, r3, lbl_sManagerList@l
...
/* 800A1EA8 0009ECA8  80 6D 90 14 */	lwz r3, lbl_sManagerCount-_SDA_BASE_(r13)
/* 800A1EAC 0009ECAC  38 03 00 01 */	addi r0, r3, 1
/* 800A1EB0 0009ECB0  90 0D 90 14 */	stw r0, lbl_sManagerCount-_SDA_BASE_(r13)
...
/* 800A1F78 0009ED78  90 0D 90 08 */	stw r0, lbl_sTableCount-_SDA_BASE_(r13)
/* 800A1F7C 0009ED7C  90 0D 90 0C */	stw r0, lbl_sTableList-_SDA_BASE_(r13)
/* 800A1F80 0009ED80  90 0D 90 14 */	stw r0, lbl_sManagerCount-_SDA_BASE_(r13)
...
/* 800A1FAC 0009EDAC  80 8D 90 08 */	lwz r4, lbl_sTableCount-_SDA_BASE_(r13)
...
/* 800A1FBC 0009EDBC  90 0D 90 08 */	stw r0, lbl_sTableCount-_SDA_BASE_(r13)
lbl_800A1FC0:
/* 800A1FC0 0009EDC0  7C 1C E8 40 */	cmplw r28, r29
/* 800A1FC4 0009EDC4  41 80 FF D8 */	blt lbl_800A1F9C
/* 800A1FC8 0009EDC8  80 0D 90 08 */	lwz r0, lbl_sTableCount-_SDA_BASE_(r13)
/* 800A1FCC 0009EDCC  28 00 00 00 */	cmplwi r0, 0
/* 800A1FD0 0009EDD0  41 82 01 80 */	beq lbl_800A2150
/* 800A1FD4 0009EDD4  80 6D 89 E0 */	lwz r3, lbl_gActiveHeap-_SDA_BASE_(r13)
...
/* 800A1FE4 0009EDE4  90 6D 90 0C */	stw r3, lbl_sTableList-_SDA_BASE_(r13)
/* 800A1FE8 0009EDE8  3B 80 00 00 */	li r28, 0
/* 800A1FEC 0009EDEC  3F E0 4C 4F */	lis r31, 0x4c4f
/* 800A1FF0 0009EDF0  83 6D 90 0C */	lwz r27, lbl_sTableList-_SDA_BASE_(r13)
...
lbl_800A2044:
/* 800A2044 0009EE44  80 6D 90 0C */	lwz r3, lbl_sTableList-_SDA_BASE_(r13)
...
/* 800A2058 0009EE58  80 6D 90 0C */	lwz r3, lbl_sTableList-_SDA_BASE_(r13)
...
/* 800A207C 0009EE7C  80 8D 90 0C */	lwz r4, lbl_sTableList-_SDA_BASE_(r13)
/* 800A2080 0009EE80  7C 64 F9 2E */	stwx r3, r4, r31
/* 800A2084 0009EE84  48 00 00 10 */	b lbl_800A2094
lbl_800A2088:
/* 800A2088 0009EE88  80 6D 90 0C */	lwz r3, lbl_sTableList-_SDA_BASE_(r13)
...
lbl_800A209C:
/* 800A209C 0009EE9C  80 0D 90 0C */	lwz r0, lbl_sTableList-_SDA_BASE_(r13)
...
/* 800A20C8 0009EEC8  80 0D 90 0C */	lwz r0, lbl_sTableList-_SDA_BASE_(r13)
...
lbl_800A20DC:
/* 800A20DC 0009EEDC  80 0D 90 0C */	lwz r0, lbl_sTableList-_SDA_BASE_(r13)
...
lbl_800A20F0:
/* 800A20F0 0009EEF0  80 0D 90 0C */	lwz r0, lbl_sTableList-_SDA_BASE_(r13)
...
lbl_800A2120:
/* 800A2120 0009EF20  80 0D 90 08 */	lwz r0, lbl_sTableCount-_SDA_BASE_(r13)
...
/* 800A2130 0009EF30  3C 60 80 3C */	lis r3, lbl_globals@ha
/* 800A2134 0009EF34  90 0D 90 14 */	stw r0, lbl_sManagerCount-_SDA_BASE_(r13)
/* 800A2138 0009EF38  38 C3 05 58 */	addi r6, r3, lbl_globals@l
...
zLOD_Update__FUi:
/* 800A2164 0009EF64  80 0D 90 14 */	lwz r0, lbl_sManagerCount-_SDA_BASE_(r13)
/* 800A2168 0009EF68  3C 80 80 3C */	lis r4, lbl_globals@ha
/* 800A216C 0009EF6C  38 84 05 58 */	addi r4, r4, lbl_globals@l
...
lbl_800A2198:
/* 800A2198 0009EF98  3C 60 80 2F */	lis r3, lbl_sManagerList@ha
/* 800A219C 0009EF9C  38 C3 A9 90 */	addi r6, r3, lbl_sManagerList@l
/* 800A21A0 0009EFA0  7C 09 03 A6 */	mtctr r0
/* 800A21A4 0009EFA4  28 00 00 00 */	cmplwi r0, 0
/* 800A21A8 0009EFA8  4D 82 00 20 */	beqlr 
lbl_800A21AC:
/* 800A21AC 0009EFAC  80 6D 90 10 */	lwz r3, lbl_sManagerIndex-_SDA_BASE_(r13)
/* 800A21B0 0009EFB0  38 03 00 01 */	addi r0, r3, 1
/* 800A21B4 0009EFB4  90 0D 90 10 */	stw r0, lbl_sManagerIndex-_SDA_BASE_(r13)
/* 800A21B8 0009EFB8  80 6D 90 10 */	lwz r3, lbl_sManagerIndex-_SDA_BASE_(r13)
/* 800A21BC 0009EFBC  80 0D 90 14 */	lwz r0, lbl_sManagerCount-_SDA_BASE_(r13)
...
/* 800A21CC 0009EFCC  90 0D 90 10 */	stw r0, lbl_sManagerIndex-_SDA_BASE_(r13)
lbl_800A21D0:
/* 800A21D0 0009EFD0  80 0D 90 10 */	lwz r0, lbl_sManagerIndex-_SDA_BASE_(r13)
...
/* 800A21F0 0009EFF0  C0 02 92 C4 */	lfs f0, lbl__705_1-_SDA2_BASE_(r2)
...
/* 800A2208 0009F008  C0 82 92 D0 */	lfs f4, lbl__714_1-_SDA2_BASE_(r2)
...
/* 800A2220 0009F020  C0 A2 92 C0 */	lfs f5, lbl__704_1-_SDA2_BASE_(r2)
lbl_800A2224:
...
/* 800A227C 0009F07C  3C A0 80 2F */	lis r5, lbl_sManagerList@ha
/* 800A2280 0009F080  38 A5 A9 90 */	addi r5, r5, lbl_sManagerList@l
/* 800A2284 0009F084  60 00 04 00 */	ori r0, r0, 0x400
/* 800A2288 0009F088  B0 03 00 44 */	sth r0, 0x44(r3)
/* 800A228C 0009F08C  80 0D 90 10 */	lwz r0, lbl_sManagerIndex-_SDA_BASE_(r13)
...
lbl_800A2338:
/* 800A2338 0009F138  80 0D 90 10 */	lwz r0, lbl_sManagerIndex-_SDA_BASE_(r13)
/* 800A233C 0009F13C  3C A0 80 2F */	lis r5, lbl_sManagerList@ha
/* 800A2340 0009F140  38 A5 A9 90 */	addi r5, r5, lbl_sManagerList@l
...
lbl_800A23BC:
/* 800A23BC 0009F1BC  80 CD 90 0C */	lwz r6, lbl_sTableList-_SDA_BASE_(r13)
/* 800A23C0 0009F1C0  38 E0 00 00 */	li r7, 0
/* 800A23C4 0009F1C4  80 0D 90 08 */	lwz r0, lbl_sTableCount-_SDA_BASE_(r13)
...
/* 800A2438 0009F238  80 0D 90 14 */	lwz r0, lbl_sManagerCount-_SDA_BASE_(r13)
/* 800A243C 0009F23C  3C A0 80 2F */	lis r5, lbl_sManagerList@ha
/* 800A2440 0009F240  7C 9E 23 78 */	mr r30, r4
/* 800A2444 0009F244  83 E3 00 24 */	lwz r31, 0x24(r3)
/* 800A2448 0009F248  38 A5 A9 90 */	addi r5, r5, lbl_sManagerList@l
...
/* 800A2468 0009F268  3C 60 80 2F */	lis r3, lbl_sManagerList@ha
/* 800A246C 0009F26C  54 9D 20 36 */	slwi r29, r4, 4
/* 800A2470 0009F270  38 03 A9 90 */	addi r0, r3, lbl_sManagerList@l
...
/* 800A2484 0009F284  C0 02 92 CC */	lfs f0, lbl__707_1-_SDA2_BASE_(r2)
...
/* 800A2494 0009F294  C0 02 92 CC */	lfs f0, lbl__707_1-_SDA2_BASE_(r2)
/* 800A2498 0009F298  3C 60 80 2F */	lis r3, lbl_sManagerList@ha
/* 800A249C 0009F29C  38 03 A9 90 */	addi r0, r3, lbl_sManagerList@l
/* 800A24A0 0009F2A0  EC 00 08 2A */	fadds f0, f0, f1
/* 800A24A4 0009F2A4  3C 60 80 3C */	lis r3, lbl_globals@ha
/* 800A24A8 0009F2A8  7C A0 EA 14 */	add r5, r0, r29
/* 800A24AC 0009F2AC  38 63 05 58 */	addi r3, r3, lbl_globals@l
...
/* 800A24BC 0009F2BC  C0 02 92 C4 */	lfs f0, lbl__705_1-_SDA2_BASE_(r2)
...
/* 800A24D4 0009F2D4  C0 82 92 D0 */	lfs f4, lbl__714_1-_SDA2_BASE_(r2)
...
/* 800A24EC 0009F2EC  C0 A2 92 C0 */	lfs f5, lbl__704_1-_SDA2_BASE_(r2)
lbl_800A24F0:
...
/* 800A2548 0009F348  3C 60 80 2F */	lis r3, lbl_sManagerList@ha
/* 800A254C 0009F34C  38 63 A9 90 */	addi r3, r3, lbl_sManagerList@l
/* 800A2550 0009F350  60 00 04 00 */	ori r0, r0, 0x400
/* 800A2554 0009F354  B0 1F 00 44 */	sth r0, 0x44(r31)
/* 800A2558 0009F358  80 0D 90 10 */	lwz r0, lbl_sManagerIndex-_SDA_BASE_(r13)
...
lbl_800A2604:
/* 800A2604 0009F404  80 0D 90 10 */	lwz r0, lbl_sManagerIndex-_SDA_BASE_(r13)
/* 800A2608 0009F408  3C 60 80 2F */	lis r3, lbl_sManagerList@ha
/* 800A260C 0009F40C  38 63 A9 90 */	addi r3, r3, lbl_sManagerList@l
