...
/* 800ACDE8 000A9BE8  3C C0 80 3C */	lis r6, lbl_globals@ha
/* 800ACDEC 000A9BEC  90 01 00 14 */	stw r0, 0x14(r1)
/* 800ACDF0 000A9BF0  38 C6 05 58 */	addi r6, r6, lbl_globals@l
...
/* 800ACE10 000A9C10  3C C0 80 29 */	lis r6, lbl__686_1@ha
/* 800ACE14 000A9C14  54 80 10 3A */	slwi r0, r4, 2
/* 800ACE18 000A9C18  38 86 00 90 */	addi r4, r6, lbl__686_1@l
/* 800ACE1C 000A9C1C  7C 04 00 2E */	lwzx r0, r4, r0
/* 800ACE20 000A9C20  7C 09 03 A6 */	mtctr r0
/* 800ACE24 000A9C24  4E 80 04 20 */	bctr 
/* 800ACE28 000A9C28  C0 22 94 B0 */	lfs f1, lbl__674-_SDA2_BASE_(r2)
...
/* 800ACE40 000A9C40  C0 22 94 B4 */	lfs f1, lbl__675-_SDA2_BASE_(r2)
...
/* 800ACE58 000A9C58  C0 22 94 B8 */	lfs f1, lbl__676_1-_SDA2_BASE_(r2)
...
/* 800ACE70 000A9C70  C0 22 94 BC */	lfs f1, lbl__677-_SDA2_BASE_(r2)
/* 800ACE74 000A9C74  7C A3 2B 78 */	mr r3, r5
/* 800ACE78 000A9C78  C0 42 94 B0 */	lfs f2, lbl__674-_SDA2_BASE_(r2)
...
/* 800ACE88 000A9C88  C0 22 94 B8 */	lfs f1, lbl__676_1-_SDA2_BASE_(r2)
...
/* 800ACEA0 000A9CA0  C0 22 94 C0 */	lfs f1, lbl__678-_SDA2_BASE_(r2)
...
/* 800ACEB8 000A9CB8  C0 22 94 B4 */	lfs f1, lbl__675-_SDA2_BASE_(r2)
...
/* 800ACECC 000A9CCC  C0 22 94 C4 */	lfs f1, lbl__679_1-_SDA2_BASE_(r2)
...
/* 800ACEE8 000A9CE8  C0 22 94 B4 */	lfs f1, lbl__675-_SDA2_BASE_(r2)
...
/* 800ACF00 000A9D00  C0 22 94 B4 */	lfs f1, lbl__675-_SDA2_BASE_(r2)
...
/* 800ACF18 000A9D18  C0 22 94 B4 */	lfs f1, lbl__675-_SDA2_BASE_(r2)
...
/* 800ACF2C 000A9D2C  C0 22 94 B4 */	lfs f1, lbl__675-_SDA2_BASE_(r2)
...
/* 800ACF48 000A9D48  C0 22 94 C8 */	lfs f1, lbl__680_2-_SDA2_BASE_(r2)
...
/* 800ACF5C 000A9D5C  C0 22 94 CC */	lfs f1, lbl__681_1-_SDA2_BASE_(r2)
...
/* 800ACF78 000A9D78  C0 22 94 C0 */	lfs f1, lbl__678-_SDA2_BASE_(r2)
...
/* 800ACF90 000A9D90  C0 22 94 D0 */	lfs f1, lbl__682_2-_SDA2_BASE_(r2)
...
/* 800ACFA8 000A9DA8  C0 22 94 D0 */	lfs f1, lbl__682_2-_SDA2_BASE_(r2)
...
/* 800ACFC0 000A9DC0  C0 22 94 D0 */	lfs f1, lbl__682_2-_SDA2_BASE_(r2)
...
/* 800ACFD8 000A9DD8  C0 22 94 D4 */	lfs f1, lbl__683_2-_SDA2_BASE_(r2)
...
/* 800ACFF0 000A9DF0  C0 22 94 D8 */	lfs f1, lbl__684_2-_SDA2_BASE_(r2)
...
/* 800AD008 000A9E08  C0 22 94 DC */	lfs f1, lbl__685_3-_SDA2_BASE_(r2)
...
/* 800AD05C 000A9E5C  3C A0 80 3C */	lis r5, lbl_globals@ha
/* 800AD060 000A9E60  7C 64 1B 78 */	mr r4, r3
/* 800AD064 000A9E64  90 01 00 14 */	stw r0, 0x14(r1)
/* 800AD068 000A9E68  38 65 05 58 */	addi r3, r5, lbl_globals@l
...
/* 800AD08C 000A9E8C  3C C0 80 3C */	lis r6, lbl_globals@ha
/* 800AD090 000A9E90  7C 85 23 78 */	mr r5, r4
/* 800AD094 000A9E94  90 01 00 14 */	stw r0, 0x14(r1)
/* 800AD098 000A9E98  38 C6 05 58 */	addi r6, r6, lbl_globals@l
...
/* 800AD0C4 000A9EC4  C0 02 94 E0 */	lfs f0, lbl__710_1-_SDA2_BASE_(r2)
...
/* 800AD0E8 000A9EE8  C0 42 94 E4 */	lfs f2, lbl__711_1-_SDA2_BASE_(r2)
/* 800AD0EC 000A9EEC  C0 02 94 E0 */	lfs f0, lbl__710_1-_SDA2_BASE_(r2)
...
/* 800AD150 000A9F50  3C 80 80 3C */	lis r4, lbl_globals@ha
/* 800AD154 000A9F54  7C 7F 1B 78 */	mr r31, r3
/* 800AD158 000A9F58  38 64 05 58 */	addi r3, r4, lbl_globals@l
...
/* 800AD178 000A9F78  3C 60 80 3C */	lis r3, lbl_globals@ha
/* 800AD17C 000A9F7C  C0 01 00 10 */	lfs f0, 0x10(r1)
/* 800AD180 000A9F80  38 63 05 58 */	addi r3, r3, lbl_globals@l
...
/* 800AD1D4 000A9FD4  3C C0 80 3C */	lis r6, lbl_globals@ha
/* 800AD1D8 000A9FD8  7C 67 1B 78 */	mr r7, r3
/* 800AD1DC 000A9FDC  90 01 00 14 */	stw r0, 0x14(r1)
/* 800AD1E0 000A9FE0  38 C6 05 58 */	addi r6, r6, lbl_globals@l
