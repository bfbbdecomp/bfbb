...
/* 800A6C14 000A3A14  80 6D 89 E0 */	lwz r3, lbl_gActiveHeap-_SDA_BASE_(r13)
...
lbl_800A6C28:
/* 800A6C28 000A3A28  90 6D 90 50 */	stw r3, lbl_g_mvpt_list-_SDA_BASE_(r13)
/* 800A6C2C 000A3A2C  93 ED 90 54 */	stw r31, lbl_g_mvpt_cnt-_SDA_BASE_(r13)
/* 800A6C30 000A3A30  80 6D 90 50 */	lwz r3, lbl_g_mvpt_list-_SDA_BASE_(r13)
...
/* 800A6CBC 000A3ABC  80 6D 90 50 */	lwz r3, lbl_g_mvpt_list-_SDA_BASE_(r13)
...
/* 800A6CE8 000A3AE8  80 0D 90 54 */	lwz r0, lbl_g_mvpt_cnt-_SDA_BASE_(r13)
/* 800A6CEC 000A3AEC  38 C0 00 00 */	li r6, 0
/* 800A6CF0 000A3AF0  80 AD 90 50 */	lwz r5, lbl_g_mvpt_list-_SDA_BASE_(r13)
...
/* 800A6E04 000A3C04  C0 02 93 C0 */	lfs f0, lbl__775_1-_SDA2_BASE_(r2)
/* 800A6E08 000A3C08  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 800A6E0C 000A3C0C  40 80 00 10 */	bge lbl_800A6E1C
/* 800A6E10 000A3C10  C0 22 93 C4 */	lfs f1, lbl__776_1-_SDA2_BASE_(r2)
