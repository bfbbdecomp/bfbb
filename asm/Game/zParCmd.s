...
/* 800A7D8C 000A4B8C  3C 60 80 2F */	lis r3, lbl_sClipVolume@ha
/* 800A7D90 000A4B90  38 80 00 00 */	li r4, 0
/* 800A7D94 000A4B94  90 01 00 54 */	stw r0, 0x54(r1)
/* 800A7D98 000A4B98  38 63 2B 50 */	addi r3, r3, lbl_sClipVolume@l
...
/* 800A7DB0 000A4BB0  3C 80 80 26 */	lis r4, lbl__stringBase0_48@ha
/* 800A7DB4 000A4BB4  3C 60 80 2F */	lis r3, lbl_sClipVolume@ha
/* 800A7DB8 000A4BB8  90 0D 90 68 */	stw r0, lbl_sClipVolumeTotal-_SDA_BASE_(r13)
/* 800A7DBC 000A4BBC  3B C4 E6 F8 */	addi r30, r4, lbl__stringBase0_48@l
/* 800A7DC0 000A4BC0  3B E3 2B 50 */	addi r31, r3, lbl_sClipVolume@l
...
/* 800A7DD8 000A4BD8  48 13 C1 5D */	bl func_801E3F34
...
/* 800A7DF0 000A4BF0  80 0D 90 68 */	lwz r0, lbl_sClipVolumeTotal-_SDA_BASE_(r13)
/* 800A7DF4 000A4BF4  54 00 10 3A */	slwi r0, r0, 2
/* 800A7DF8 000A4BF8  7C 7F 01 2E */	stwx r3, r31, r0
/* 800A7DFC 000A4BFC  80 6D 90 68 */	lwz r3, lbl_sClipVolumeTotal-_SDA_BASE_(r13)
/* 800A7E00 000A4C00  38 03 00 01 */	addi r0, r3, 1
/* 800A7E04 000A4C04  90 0D 90 68 */	stw r0, lbl_sClipVolumeTotal-_SDA_BASE_(r13)
lbl_800A7E08:
/* 800A7E08 000A4C08  80 AD 90 68 */	lwz r5, lbl_sClipVolumeTotal-_SDA_BASE_(r13)
...
/* 800A7E48 000A4C48  3C 60 80 3C */	lis r3, lbl_globals@ha
/* 800A7E4C 000A4C4C  38 63 05 58 */	addi r3, r3, lbl_globals@l
...
/* 800A7E8C 000A4C8C  C0 02 93 E8 */	lfs f0, lbl__804-_SDA2_BASE_(r2)
...
/* 800A7ECC 000A4CCC  C0 02 93 E8 */	lfs f0, lbl__804-_SDA2_BASE_(r2)
...
/* 800A7F04 000A4D04  3C 60 80 2F */	lis r3, lbl_sClipVolume@ha
/* 800A7F08 000A4D08  90 01 00 74 */	stw r0, 0x74(r1)
/* 800A7F0C 000A4D0C  93 E1 00 6C */	stw r31, 0x6c(r1)
/* 800A7F10 000A4D10  3B E3 2B 50 */	addi r31, r3, lbl_sClipVolume@l
...
/* 800A7F58 000A4D58  C0 02 93 E8 */	lfs f0, lbl__804-_SDA2_BASE_(r2)
...
lbl_800A7F68:
/* 800A7F68 000A4D68  80 0D 90 68 */	lwz r0, lbl_sClipVolumeTotal-_SDA_BASE_(r13)
...
/* 800A7FD8 000A4DD8  3C A0 80 3C */	lis r5, lbl_globals@ha
/* 800A7FDC 000A4DDC  FF 80 08 90 */	fmr f28, f1
/* 800A7FE0 000A4DE0  38 A5 05 58 */	addi r5, r5, lbl_globals@l
...
/* 800A800C 000A4E0C  C0 22 93 EC */	lfs f1, lbl__852_1-_SDA2_BASE_(r2)
...
/* 800A8134 000A4F34  3C A0 80 3C */	lis r5, lbl_globals@ha
...
/* 800A8148 000A4F48  38 65 05 58 */	addi r3, r5, lbl_globals@l
...
lbl_800A817C:
/* 800A817C 000A4F7C  3C 60 80 2F */	lis r3, lbl_collis$867@ha
/* 800A8180 000A4F80  38 80 00 00 */	li r4, 0
/* 800A8184 000A4F84  38 63 2B D0 */	addi r3, r3, lbl_collis$867@l
/* 800A8188 000A4F88  38 A0 00 50 */	li r5, 0x50
/* 800A818C 000A4F8C  4B F5 B2 CD */	bl memset
/* 800A8190 000A4F90  3C 60 80 2F */	lis r3, lbl_bnd_fake$868@ha
/* 800A8194 000A4F94  38 80 00 00 */	li r4, 0
/* 800A8198 000A4F98  38 63 2C 20 */	addi r3, r3, lbl_bnd_fake$868@l
/* 800A819C 000A4F9C  38 A0 00 4C */	li r5, 0x4c
/* 800A81A0 000A4FA0  4B F5 B2 B9 */	bl memset
/* 800A81A4 000A4FA4  3C 60 80 2F */	lis r3, lbl_bnd_fake$868@ha
/* 800A81A8 000A4FA8  38 00 00 01 */	li r0, 1
/* 800A81AC 000A4FAC  3B 63 2C 20 */	addi r27, r3, lbl_bnd_fake$868@l
...
/* 800A8204 000A5004  3C 60 80 2F */	lis r3, lbl_bnd_fake$868@ha
/* 800A8208 000A5008  38 63 2C 20 */	addi r3, r3, lbl_bnd_fake$868@l
/* 800A820C 000A500C  7C 64 1B 78 */	mr r4, r3
/* 800A8210 000A5010  4B F6 2D 2D */	bl xQuickCullForBound__FP7xQCDataPC6xBound
/* 800A8214 000A5014  3C 60 80 2F */	lis r3, lbl_bnd_fake$868@ha
/* 800A8218 000A5018  3C A0 80 2F */	lis r5, lbl_collis$867@ha
/* 800A821C 000A501C  38 63 2C 20 */	addi r3, r3, lbl_bnd_fake$868@l
/* 800A8220 000A5020  7F 84 E3 78 */	mr r4, r28
/* 800A8224 000A5024  38 A5 2B D0 */	addi r5, r5, lbl_collis$867@l
...
lbl_800A823C:
/* 800A823C 000A503C  3C 60 80 2F */	lis r3, lbl_collis$867@ha
/* 800A8240 000A5040  80 03 2B D0 */	lwz r0, lbl_collis$867@l(r3)
...
/* 800A82D0 000A50D0  3C 60 80 3C */	lis r3, lbl_globals@ha
/* 800A82D4 000A50D4  38 63 05 58 */	addi r3, r3, lbl_globals@l
...
/* 800A8360 000A5160  C0 02 94 04 */	lfs f0, lbl__921_2-_SDA2_BASE_(r2)
/* 800A8364 000A5164  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 800A8368 000A5168  40 80 00 0C */	bge lbl_800A8374
/* 800A836C 000A516C  C0 02 93 EC */	lfs f0, lbl__852_1-_SDA2_BASE_(r2)
/* 800A8370 000A5170  48 00 00 08 */	b lbl_800A8378
lbl_800A8374:
/* 800A8374 000A5174  C0 02 93 E8 */	lfs f0, lbl__804-_SDA2_BASE_(r2)
lbl_800A8378:
/* 800A8378 000A5178  D0 01 00 08 */	stfs f0, 8(r1)
/* 800A837C 000A517C  C0 21 00 10 */	lfs f1, 0x10(r1)
/* 800A8380 000A5180  C0 02 94 04 */	lfs f0, lbl__921_2-_SDA2_BASE_(r2)
/* 800A8384 000A5184  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 800A8388 000A5188  40 80 00 0C */	bge lbl_800A8394
/* 800A838C 000A518C  C0 02 93 EC */	lfs f0, lbl__852_1-_SDA2_BASE_(r2)
/* 800A8390 000A5190  48 00 00 08 */	b lbl_800A8398
lbl_800A8394:
/* 800A8394 000A5194  C0 02 93 E8 */	lfs f0, lbl__804-_SDA2_BASE_(r2)
lbl_800A8398:
...
/* 800A8428 000A5228  3C 60 80 3C */	lis r3, lbl_globals@ha
/* 800A842C 000A522C  83 E4 00 00 */	lwz r31, 0(r4)
/* 800A8430 000A5230  38 63 05 58 */	addi r3, r3, lbl_globals@l
...
/* 800A8454 000A5254  C0 42 94 08 */	lfs f2, lbl__954_2-_SDA2_BASE_(r2)
/* 800A8458 000A5258  C0 02 94 0C */	lfs f0, lbl__955_3-_SDA2_BASE_(r2)
...
/* 800A848C 000A528C  C0 02 93 F4 */	lfs f0, lbl__854_1-_SDA2_BASE_(r2)
...
/* 800A84B4 000A52B4  C0 02 93 FC */	lfs f0, lbl__892-_SDA2_BASE_(r2)
...
/* 800A84D8 000A52D8  C0 02 93 EC */	lfs f0, lbl__852_1-_SDA2_BASE_(r2)
...
/* 800A851C 000A531C  3C 60 80 3C */	lis r3, lbl_globals@ha
/* 800A8520 000A5320  C0 02 94 04 */	lfs f0, lbl__921_2-_SDA2_BASE_(r2)
/* 800A8524 000A5324  38 63 05 58 */	addi r3, r3, lbl_globals@l
...
lbl_800A857C:
/* 800A857C 000A537C  C0 02 94 04 */	lfs f0, lbl__921_2-_SDA2_BASE_(r2)
...
lbl_800A85D4:
/* 800A85D4 000A53D4  C0 02 94 04 */	lfs f0, lbl__921_2-_SDA2_BASE_(r2)
...
lbl_800A8684:
/* 800A8684 000A5484  3C 60 80 3C */	lis r3, lbl_globals@ha
/* 800A8688 000A5488  C0 02 94 08 */	lfs f0, lbl__954_2-_SDA2_BASE_(r2)
/* 800A868C 000A548C  38 63 05 58 */	addi r3, r3, lbl_globals@l
...
/* 800A86DC 000A54DC  C0 02 94 10 */	lfs f0, lbl__1022_2-_SDA2_BASE_(r2)
...
/* 800A86F4 000A54F4  C0 02 94 14 */	lfs f0, lbl__1023_2-_SDA2_BASE_(r2)
...
/* 800A8708 000A5508  C0 02 94 04 */	lfs f0, lbl__921_2-_SDA2_BASE_(r2)
/* 800A870C 000A550C  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 800A8710 000A5510  40 80 00 0C */	bge lbl_800A871C
/* 800A8714 000A5514  C0 02 93 EC */	lfs f0, lbl__852_1-_SDA2_BASE_(r2)
/* 800A8718 000A5518  48 00 00 08 */	b lbl_800A8720
lbl_800A871C:
/* 800A871C 000A551C  C0 02 93 E8 */	lfs f0, lbl__804-_SDA2_BASE_(r2)
lbl_800A8720:
/* 800A8720 000A5520  D0 01 00 08 */	stfs f0, 8(r1)
/* 800A8724 000A5524  C0 21 00 10 */	lfs f1, 0x10(r1)
/* 800A8728 000A5528  C0 02 94 04 */	lfs f0, lbl__921_2-_SDA2_BASE_(r2)
/* 800A872C 000A552C  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 800A8730 000A5530  40 80 00 0C */	bge lbl_800A873C
/* 800A8734 000A5534  C0 02 93 EC */	lfs f0, lbl__852_1-_SDA2_BASE_(r2)
/* 800A8738 000A5538  48 00 00 08 */	b lbl_800A8740
lbl_800A873C:
/* 800A873C 000A553C  C0 02 93 E8 */	lfs f0, lbl__804-_SDA2_BASE_(r2)
lbl_800A8740:
...
/* 800A874C 000A554C  C0 42 94 18 */	lfs f2, lbl__1024_1-_SDA2_BASE_(r2)
/* 800A8750 000A5550  EC 01 00 2A */	fadds f0, f1, f0
/* 800A8754 000A5554  C0 62 93 EC */	lfs f3, lbl__852_1-_SDA2_BASE_(r2)
...
lbl_800A877C:
/* 800A877C 000A557C  C0 02 94 04 */	lfs f0, lbl__921_2-_SDA2_BASE_(r2)
/* 800A8780 000A5580  D0 1F 00 20 */	stfs f0, 0x20(r31)
/* 800A8784 000A5584  C0 02 94 04 */	lfs f0, lbl__921_2-_SDA2_BASE_(r2)
/* 800A8788 000A5588  D0 1F 00 24 */	stfs f0, 0x24(r31)
/* 800A878C 000A558C  C0 02 94 04 */	lfs f0, lbl__921_2-_SDA2_BASE_(r2)
...
/* 800A87B8 000A55B8  C0 22 94 1C */	lfs f1, lbl__1025_1-_SDA2_BASE_(r2)
