...
F32 ArcLength3( xCoef3* coef, F64 ustart, F64 uend) {
  ...
  return (h * (sum + 
            xsqrt(A + ustart * (B + ustart * (C + ustart * (D + E * ustart)))) +
...
void BasisToCoef3(xCoef3* coef, F32 (*N)[4], xVec3* v1, xVec3* v2, xVec3* v3, xVec3* v4) {
  ...
  for (i = 4; i != 0; i -= 1) {
      coef->x.a[0] = (N[3][0] * v4->x) + ((N[2][0] * v3->x) + ((v1->x * N[0][0]) + (N[1][0] * v2->x)));
      coef->y.a[0] = (N[3][0] * v4->y) + ((N[2][0] * v3->y) + ((v1->y * N[0][0]) + (N[1][0] * v2->y)));
      N += 4;
      coef->z.a[0] = (N[3][0] * v4->z) + ((N[2][0] * v3->z) + (v1->z * N[0][0]) + (N[1][0] * v2->z));
      coef += 4;
  }
}
...
void CoefToUnity3(xCoef3* coef1, xCoef3* coef2, F32 f1, F32 f2) {
  ...
  for (i = 3; i == 1; i -= 1) {
      ...
      coef1->x.a[3] = coef2_3 + ((coef2_2 * f1) + ((f1 * (f1 * coef2_0 * f1)) + (f1 * coef2_1 * f1)));
...
void EvalCoef3(xCoef3* coef, F32 u, U32 deriv, xVec3* o) {
  switch ((S32) deriv) {                          
  case 0:
      o->x = (u * ((u * (((coef->x).a[0] * u) + (coef->x).a[1])) + (coef->x).a[2])) + (coef->x).a[3];
      o->y = (u * ((u * (((coef->y).a[0] * u) + (coef->y).a[1])) + (coef->y).a[2])) + (coef->y).a[3];
      o->z = (u * ((u * (((coef->z).a[0] * u) + (coef->z).a[1])) + (coef->z).a[2])) + (coef->z).a[3];
      return;
  case 1:
...
xCoef3* CoefSeg3(xSpline3* spl, U32 seg, xCoef3* tempCoef) {
  ...
  case 2:
      BasisToCoef3(tempCoef, sBasisHermite, spl->points + (seg * 0xC), spl->p12 + (seg * 0x18), spl->p12 + (seg * 0x18) + 0xC, spl->points + (seg * 0xC) + 0xC);
      return tempCoef;
  case 3:
      BasisToCoef3(tempCoef, sBasisBezier, spl->points + (seg * 0xC), spl->p12 + (seg * 0x18), spl->p12 + (seg * 0x18) + 0xC, spl->points + (seg * 0xC) + 0xC);
      return tempCoef;
  case 4:
      BasisBspline(&N, &spl->knot[seg]);
      temp_bctrl = spl->bctrl + (seg * 0xC);
      BasisToCoef3(tempCoef, &N, temp_bctrl, temp_bctrl + 0xC, temp_bctrl + 0x18, temp_bctrl + 0x24);
...
void xSpline3_EvalSeg(xSpline3* spl, F32 u, U32 deriv, xVec3* o) {
  ...
  case 1:
      ...
      return;
  case 2:
      BasisToCoef3(&tempCoef, (f32 (*)[4]) sBasisHermite, spl->points + (seg * 0xC), spl->p12 + (seg * 0x18), spl->p12 + (seg * 0x18) + 0xC, spl->points + (seg * 0xC) + 0xC);
      EvalCoef3(&tempCoef, new_u, deriv, o);
      return;
  case 3:
      BasisToCoef3(&tempCoef, (F32 (*)[4]) sBasisBezier, spl->points + (seg * 0xC), spl->p12 + (seg * 0x18), spl->p12 + (seg * 0x18) + 0xC, spl->points + (seg * 0xC) + 0xC);
      EvalCoef3(&tempCoef, new_u, deriv, o);
      return;
  }
}
