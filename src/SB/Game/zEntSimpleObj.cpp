...
void zEntSimpleObj_Init(zEntSimpleObj* ent, xEntAsset* asset, s8 arg2)
{
    ...
    var_r31 = NULL;
    if (!(ent->miscflags & 1) && ((u32)ent->asset->animListID != 0U) &&
        (temp_r3 = ent->model, ((temp_r3 == NULL) == 0)) &&
        (temp_r3_2 = temp_r3->unkC, ((temp_r3_2 == NULL) == 0)) &&
        (temp_r4 = temp_r3_2->unk10, ((temp_r4 == NULL) == 0)) &&
        (strcmp("xEntAutoEventSimple", temp_r4->unk4) == 0))
    {
