...
RADCFUNC void Resize_RAD_3D(HRAD3D rad_3d, U32 width, U32 height);
...
#else
                                       S32 alpha_pixels, U32 maximum_texture_size RADDEFAULT(256)
#endif
);

RADCFUNC void Close_RAD_3D_image(HRAD3DIMAGE rad_image);

// RADCFUNC S32 Lock_RAD_3D_image(HRAD3DIMAGE rad_image, void* out_pixel_buffer, U32* out_buffer_pitch,
